...
for marginal_plot_type = 1:1:2
   ...
   if ( plot_rr )
      ...
      plot_CLUBB_PDF_LES_pts_L( sam_var_lev(idx_3D_rr,:), ...
                                ...
                                [ 'Altitude = ', print_alt, ' meters' ],...
                                print_note, use_long_title, ...
                                'rain water mixing ratio, \itr_{r}' )
   ...
   if ( plot_Nr )
      ...
      plot_CLUBB_PDF_LES_pts_L( sam_var_lev(idx_3D_Nr,:), ...
                                ...
                                [ 'Altitude = ', print_alt, ' meters' ],...
                                print_note, use_long_title, ...
                                'rain drop concentration, \itN_{r}' )
   ...
   if ( strcmp( casename, 'LBA' ) )
      ...
      if ( plot_ri )
         ...
         plot_CLUBB_PDF_LES_pts_L( sam_var_lev(idx_3D_ri,:), ...
                                   ...
                                   precip_frac_1, precip_frac_2, ...
                                   mixt_frac, '\itr_{i}    \rm[kg kg^{-1}]', ...
                                   [ '\bf ', casename ], 'r_{i}', ...
                                   [ 'Time = ', print_time, ' minutes' ], ...
                                   [ 'Altitude = ', print_alt, ' meters' ],...
                                   print_note, use_long_title, ...
                                   'ice mixing ratio, \itr_{i}' )
      ...
      if ( plot_Ni )
         ...
         plot_CLUBB_PDF_LES_pts_L( sam_var_lev(idx_3D_Ni,:), ...
                                   ...
                                   precip_frac_1, precip_frac_2, ...
                                   mixt_frac, '\itN_{i}    \rm[kg^{-1}]', ...
                                   [ '\bf ', casename ], 'N_{i}', ...
                                   [ 'Time = ', print_time, ' minutes' ], ...
                                   [ 'Altitude = ', print_alt, ' meters' ],...
                                   print_note, use_long_title, ...
                                   'ice concentration, \itN_{i}' )
      ...
      if ( plot_rs )
         ...
         plot_CLUBB_PDF_LES_pts_L( sam_var_lev(idx_3D_rs,:), ...
                                   ...
                                   precip_frac_1, precip_frac_2, ...
                                   mixt_frac, '\itr_{s}    \rm[kg kg^{-1}]', ...
                                   [ '\bf ', casename ], 'r_{s}', ...
                                   [ 'Time = ', print_time, ' minutes' ], ...
                                   [ 'Altitude = ', print_alt, ' meters' ],...
                                   print_note, use_long_title, ...
                                   'snow mixing ratio, \itr_{s}' )
      ...
      if ( plot_Ns )
         ...
         plot_CLUBB_PDF_LES_pts_L( sam_var_lev(idx_3D_Ns,:), ...
                                   ...
                                   precip_frac_1, precip_frac_2, ...
                                   mixt_frac, '\itN_{s}    \rm[kg^{-1}]', ...
                                   [ '\bf ', casename ], 'N_{s}', ...
                                   [ 'Time = ', print_time, ' minutes' ], ...
                                   [ 'Altitude = ', print_alt, ' meters' ],...
                                   print_note, use_long_title, ...
                                   'snow concentration, \itN_{s}' )
      ...
      if ( plot_rg )
         ...
         plot_CLUBB_PDF_LES_pts_L( sam_var_lev(idx_3D_rg,:), ...
                                   ...
                                   precip_frac_1, precip_frac_2, ...
                                   mixt_frac, '\itr_{g}    \rm[kg kg^{-1}]', ...
                                   [ '\bf ', casename ], 'r_{g}', ...
                                   [ 'Time = ', print_time, ' minutes' ], ...
                                   [ 'Altitude = ', print_alt, ' meters' ],...
                                   print_note, use_long_title, ...
                                   'graupel mixing ratio, \itr_{g}' )
      ...
      if ( plot_Ng )
         ...
         plot_CLUBB_PDF_LES_pts_L( sam_var_lev(idx_3D_Ng,:), ...
                                   ...
                                   precip_frac_1, precip_frac_2, ...
                                   mixt_frac, '\itN_{g}    \rm[kg^{-1}]', ...
                                   [ '\bf ', casename ], 'N_{g}', ...
                                   [ 'Time = ', print_time, ' minutes' ], ...
                                   [ 'Altitude = ', print_alt, ' meters' ],...
                                   print_note, use_long_title, ...
                                   'graupel concentration, \itN_{g}' )
...
if ( strcmp( casename, 'LBA' ) )
   ...
   if ( plot_ln_ri )
      ...
      plot_CLUBB_PDF_LES_pts_ln_L( sam_var_lev(idx_3D_ri,:), ...
                                   ...
                                   mixt_frac, [ 'ln \itr_{i}', ...
                                   '    \rm[ln(kg kg^{-1})]' ], ...
                                   [ '\bf ', casename ], '\rmln \itr_{i}', ...
                                   [ 'Time = ', print_time, ' minutes' ], ...
                                   [ 'Altitude = ', print_alt, ' meters' ], ...
                                   print_note, use_long_title, ...
                                   [ 'Natural log of ice', ...
                                     ' mixing ratio, ln \itr_{i}' ] )
   ...
   if ( plot_ln_Ni )
      ...
      plot_CLUBB_PDF_LES_pts_ln_L( sam_var_lev(idx_3D_Ni,:), ...
                                   ...
                                   mixt_frac, [ 'ln \itN_{i}', ...
                                   '    \rm[ln(kg^{-1})]' ], ...
                                   [ '\bf ', casename ], '\rmln \itN_{i}', ...
                                   [ 'Time = ', print_time, ' minutes' ], ...
                                   [ 'Altitude = ', print_alt, ' meters' ], ...
                                   print_note, use_long_title, ...
                                   [ 'Natural log of ice', ...
                                     ' concentration, ln \itN_{i}' ] )
   ...
   if ( plot_ln_rs )
      ...
      plot_CLUBB_PDF_LES_pts_ln_L( sam_var_lev(idx_3D_rs,:), ...
                                   ...
                                   mixt_frac, [ 'ln \itr_{s}', ...
                                   '    \rm[ln(kg kg^{-1})]' ], ...
                                   [ '\bf ', casename ], '\rmln \itr_{s}', ...
                                   [ 'Time = ', print_time, ' minutes' ], ...
                                   [ 'Altitude = ', print_alt, ' meters' ], ...
                                   print_note, use_long_title, ...
                                   [ 'Natural log of snow', ...
                                     ' mixing ratio, ln \itr_{s}' ] )
   ...
   if ( plot_ln_Ns )
      ...
      plot_CLUBB_PDF_LES_pts_ln_L( sam_var_lev(idx_3D_Ns,:), ...
                                   ...
                                   mixt_frac, [ 'ln \itN_{s}', ...
                                   '    \rm[ln(kg^{-1})]' ], ...
                                   [ '\bf ', casename ], '\rmln \itN_{s}', ...
                                   [ 'Time = ', print_time, ' minutes' ], ...
                                   [ 'Altitude = ', print_alt, ' meters' ], ...
                                   print_note, use_long_title, ...
                                   [ 'Natural log of snow', ...
                                     ' concentration, ln \itN_{s}' ] )
   ...
   if ( plot_ln_rg )
      ...
      plot_CLUBB_PDF_LES_pts_ln_L( sam_var_lev(idx_3D_rg,:), ...
                                   ...
                                   mixt_frac, [ 'ln \itr_{g}', ...
                                   '    \rm[ln(kg kg^{-1})]' ], ...
                                   [ '\bf ', casename ], '\rmln \itr_{g}', ...
                                   [ 'Time = ', print_time, ' minutes' ], ...
                                   [ 'Altitude = ', print_alt, ' meters' ], ...
                                   print_note, use_long_title, ...
                                   [ 'Natural log of graupel', ...
                                     ' mixing ratio, ln \itr_{g}' ] )
   ...
   if ( plot_ln_Ng )
      ...
      plot_CLUBB_PDF_LES_pts_ln_L( sam_var_lev(idx_3D_Ng,:), ...
                                   ...
                                   mixt_frac, [ 'ln \itN_{g}', ...
                                   '    \rm[ln(kg^{-1})]' ], ...
                                   [ '\bf ', casename ], '\rmln \itN_{g}', ...
                                   [ 'Time = ', print_time, ' minutes' ], ...
                                   [ 'Altitude = ', print_alt, ' meters' ], ...
                                   print_note, use_long_title, ...
                                   [ 'Natural log of graupel', ...
                                     ' concentration, ln \itN_{g}' ] )
