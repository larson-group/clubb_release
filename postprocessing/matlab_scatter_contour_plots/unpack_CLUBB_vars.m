% $Id$
function [ mu_w_1, mu_w_2, mu_rt_1, ...
           mu_rt_2, mu_thl_1, mu_thl_2, ...
           mu_chi_1, mu_chi_2, mu_eta_1, ...
           mu_eta_2, mu_rr_1_n, mu_rr_2_n, ...
           mu_Nr_1_n, mu_Nr_2_n, ...
           sigma_w_1, sigma_w_2, ...
           ...
           precip_frac_2, sigma_sqd_w ] ...
= unpack_CLUBB_vars( var_clubb, clubb_height_idx, clubb_time_idx )
...
corr_rt_thl_1 = var_clubb( idx_corr_rt_thl_1, 1, 1, ...
                           clubb_height_idx, clubb_time_idx );
corr_rt_thl_2 = var_clubb( idx_corr_rt_thl_2, 1, 1, ...
                           clubb_height_idx, clubb_time_idx );
