...
# Definitions
#----------------------------------------------------------------------------------------
def find_sams_timestep(filename):
    # User passes in SAM's statistical file. Return the timestep of the SAM 
    # simulation
    nc = netCDF4.Dataset(filename)
    time, units = pull_samples(nc, 'time')
    nc.close()
...
clubb_3D_dir = '/home/weberjk/Summarize_Progress/CLUBB/output/'
...
out_dir = '/home/weberjk/Summarize_Progress/CLUBB/output/' # Figure output directory
