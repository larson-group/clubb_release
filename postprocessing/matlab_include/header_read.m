...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Originally written by Cory Behnke, 2004
% This version modified by Michael Falk, 2005-2007
% This header written 8 March 2007
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Input parameters: file_header (The path and name of a .ctl file)
% Input files: The specified .ctl
% Output parameters: filename of .dat file, number of z levels, array
%                    of z levels, number of timesteps, number of variables,
