...
plot_rms_n_dir_all "$CLUBB_DIR" rico_lh "$PLOTS_OUTPUT_DIR/rico_lh_rms" "$SIM_OUTPUT_DIR/rico_lh/cloud_weighted" "$SIM_OUTPUT_DIR/rico_lh/prescribed"

echo -e "\n-----Generating dycoms2_rf02_do RMS plots-----"
mkdir "$PLOTS_OUTPUT_DIR/dycoms2_rf02_do_rms"
plot_rms_n_dir_all "$CLUBB_DIR" dycoms2_rf02_do "$PLOTS_OUTPUT_DIR/dycoms2_rf02_do_rms" "$SIM_OUTPUT_DIR/dycoms2_rf02_do/cloud_weighted" "$SIM_OUTPUT_DIR/dycoms2_rf02_do/prescribed"
...
turn_on_presc_probs "$CLUBB_DIR/input/case_setups/rico_lh_model.in"
turn_on_presc_probs "$CLUBB_DIR/input/case_setups/dycoms2_rf02_do_model.in"
...
plot_rms_n_dir_all "$CLUBB_DIR" rico_lh "$PLOTS_OUTPUT_DIR/rico_lh_rms_subopt" "$SIM_OUTPUT_DIR/rico_lh/cloud_weighted" "$SIM_OUTPUT_DIR/rico_lh/prescribed" "$SIM_OUTPUT_DIR/rico_lh/prescribed_subopt"

echo -e "\n-----Generating dycoms2_rf02_do RMS plots-----"
mkdir "$PLOTS_OUTPUT_DIR/dycoms2_rf02_do_rms_subopt"
plot_rms_n_dir_all "$CLUBB_DIR" dycoms2_rf02_do "$PLOTS_OUTPUT_DIR/dycoms2_rf02_do_rms_subopt" "$SIM_OUTPUT_DIR/dycoms2_rf02_do/cloud_weighted" "$SIM_OUTPUT_DIR/dycoms2_rf02_do/prescribed" "$SIM_OUTPUT_DIR/dycoms2_rf02_do/prescribed_subopt"
