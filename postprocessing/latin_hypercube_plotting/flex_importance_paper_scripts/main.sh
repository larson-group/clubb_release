...
plot_timeseries_n_dir_all "$CLUBB_DIR" rico_lh "$PLOTS_OUTPUT_DIR/rico_lh_timeseries.pdf" "$SIM_OUTPUT_DIR/rico_lh/2Cat-CldPcp" "$SIM_OUTPUT_DIR/rico_lh/8Cat" "$SIM_OUTPUT_DIR/rico_lh/2Cat-Cld"
