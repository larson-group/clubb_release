...
class VariableGroupBase(VariableGroup):
    ...
    def __init__(self, ncdf_file, sam_file = None):
        ...
        ### Plot / Panel pairs
        # liq_pot_temp_panel = Panel('thlm', ncdf_file, averaging_start_time=averaging_start_time,
        ...
        # tot_water_mix_panel = Panel('RTM', ncdf_file, averaging_start_time=averaging_start_time,
        ...
        #                             independent_max_value=height_max_value, sam_file=sam_file)
        turbulent_flux__theta_panel = Panel('wpthlp', ncdf_file, averaging_start_time=averaging_start_time,
                                            ...
                                            independent_max_value=height_max_value, sam_file=sam_file)
        turbulent_flux_r_panel = Panel('wprtp', ncdf_file, averaging_start_time=averaging_start_time,
                                       ...
                                       independent_max_value=height_max_value, sam_file=sam_file)
        # wp3_panel = Panel('wp3', ncdf_file, averaging_start_time=averaging_start_time,
        ...
        #                   independent_max_value=height_max_value, sam_file=sam_file)
        wp2_panel = Panel('wp2', ncdf_file, averaging_start_time=averaging_start_time,
        ...
        rtp2_panel = Panel('rtp2', ncdf_file, averaging_start_time=averaging_start_time,
                           ...
                           independent_max_value=height_max_value,sam_file=sam_file)
        # wm_panel = Panel('WM', ncdf_file, averaging_start_time=averaging_start_time, averaging_end_time=averaging_end_time, title="Vertical Wind Component, w (subsidence)", dependant_title='wm [m/s]', independent_min_value=height_min_value, independent_max_value=height_max_value, sam_enabled=True, sam_file=sam_file, sam_name='WM')
        ...
        # liq_water_path = Panel('CWP', ncdf_file, panel_type=Panel.TYPE_TIMESERIES, title="Liquid Water Path",
        ...
        den_wgt_avg = Panel('wp2', ncdf_file, averaging_start_time=averaging_start_time, panel_type=Panel.TYPE_TIMESERIES,
        ...
        ### Build panels ###
        self.panels = [ turbulent_flux__theta_panel, turbulent_flux_r_panel, wp2_panel, den_wgt_avg]
