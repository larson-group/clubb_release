...
class VariableGroupBaseBudgets(VariableGroup):
    ...
    def __init__(self, ncdf_datasets, case, sam_file=None):
        ...
        self.variable_definitions = [
            {'clubb_name': 'thlm', 'lines': thlm_lines, 'type': Panel.TYPE_BUDGET},
            {'clubb_name': 'rtm', 'lines': rtm_lines, 'type': Panel.TYPE_BUDGET},
            {'clubb_name': 'wpthlp', 'lines': wpthlp_lines, 'type': Panel.TYPE_BUDGET},
            {'clubb_name': 'wprtp', 'lines': wprtp_lines, 'type': Panel.TYPE_BUDGET},
            {'clubb_name': 'wp2', 'lines': wp2_lines, 'type': Panel.TYPE_BUDGET},
            {'clubb_name': 'wp3', 'lines': wp3_lines, 'type': Panel.TYPE_BUDGET},
            {'clubb_name': 'thlp2', 'lines': thlp2_lines, 'type': Panel.TYPE_BUDGET},
            {'clubb_name': 'rtp2', 'lines': rtp2_lines, 'type': Panel.TYPE_BUDGET},
            {'clubb_name': 'rtpthlp', 'lines': rtpthlp_lines, 'type': Panel.TYPE_BUDGET},
            {'clubb_name': 'upwp', 'lines': upwp_lines, 'type': Panel.TYPE_BUDGET},
            {'clubb_name': 'vpwp', 'lines': vpwp_lines, 'type': Panel.TYPE_BUDGET},
    ...
    def getThlmClipping(self):
        ...
        z_ncdf = self.__getFallbackVar__('altitude', self.ncdf_files['zt'])
        thlm_mfl = self.__getFallbackVar__('thlm_mfl', self.ncdf_files['zt'])
        thlm_cl = self.__getFallbackVar__('thlm_cl', self.ncdf_files['zt'])
        thlm_tacl = self.__getFallbackVar__('thlm_tacl', self.ncdf_files['zt'])
        thlm_sdmp = self.__getFallbackVar__('thlm_sdmp', self.ncdf_files['zt'])
    ...
    def getLsforcing(self):
        ...
        '''
        z_ncdf = self.__getFallbackVar__('altitude', self.ncdf_files['zt'])
        thlm_forcing = self.__getFallbackVar__('thlm_forcing', self.ncdf_files['zt'])
        radht = self.__getFallbackVar__('radht', self.ncdf_files['zt'])
        thlm_mc = self.__getFallbackVar__('thlm_mc', self.ncdf_files['zt'])
    ...
    def getThlmResidual(self):
        ...
        thlm_tacl = self.__getFallbackVar__('thlm_tacl', self.ncdf_files['zt'])
        thlm_sdmp = self.__getFallbackVar__('thlm_sdmp', self.ncdf_files['zt'])
        thlm_bt = self.__getFallbackVar__('thlm_bt', self.ncdf_files['zt'])
        thlm_ta = self.__getFallbackVar__('thlm_ta', self.ncdf_files['zt'])
        thlm_forcing = self.__getFallbackVar__('thlm_forcing', self.ncdf_files['zt'])
        thlm_ma = self.__getFallbackVar__('thlm_ma', self.ncdf_files['zt'])
    ...
    def getRtmClipping(self):
        ...
        '''
        z_ncdf = self.__getFallbackVar__('altitude', self.ncdf_files['zt'])
        rtm_mfl = self.__getFallbackVar__('rtm_mfl', self.ncdf_files['zt'])
        rtm_cl = self.__getFallbackVar__('rtm_cl', self.ncdf_files['zt'])
        rtm_tacl = self.__getFallbackVar__('rtm_tacl', self.ncdf_files['zt'])
        rtm_sdmp = self.__getFallbackVar__('rtm_sdmp', self.ncdf_files['zt'])
    ...
    def getRtmForcing(self):
        ...
        '''
        z_ncdf = self.__getFallbackVar__('altitude', self.ncdf_files['zt'])
        rtm_mc = self.__getFallbackVar__('rtm_mc', self.ncdf_files['zt'])
        rtm_forcing = self.__getFallbackVar__('rtm_forcing', self.ncdf_files['zt'])
    ...
    def getRtmResidual(self):
        ...
        rtm_tacl = self.__getFallbackVar__('rtm_tacl', self.ncdf_files['zt'])
        rtm_sdmp = self.__getFallbackVar__('rtm_sdmp', self.ncdf_files['zt'])
        rtm_bt = self.__getFallbackVar__('rtm_bt', self.ncdf_files['zt'])
        rtm_ta = self.__getFallbackVar__('rtm_ta', self.ncdf_files['zt'])
        rtm_forcing = self.__getFallbackVar__('rtm_forcing', self.ncdf_files['zt'])
        rtm_pd = self.__getFallbackVar__('rtm_pd', self.ncdf_files['zt'])
        rtm_ma = self.__getFallbackVar__('rtm_ma', self.ncdf_files['zt'])
    ...
    def getWpthlpResidual(self):
        ...
        :return:
        '''
        z_ncdf = self.__getFallbackVar__('altitude', self.ncdf_files['zm'])
        wpthlp_mfl = self.__getFallbackVar__('wpthlp_mfl', self.ncdf_files['zm'])
        wpthlp_cl = self.__getFallbackVar__('wpthlp_cl', self.ncdf_files['zm'])
        wpthlp_tp = self.__getFallbackVar__('wpthlp_tp', self.ncdf_files['zm'])
        wpthlp_ac = self.__getFallbackVar__('wpthlp_ac', self.ncdf_files['zm'])
        wpthlp_pr1 = self.__getFallbackVar__('wpthlp_pr1', self.ncdf_files['zm'])
        wpthlp_pr3 = self.__getFallbackVar__('wpthlp_pr3', self.ncdf_files['zm'])
        wpthlp_pr2 = self.__getFallbackVar__('wpthlp_pr2', self.ncdf_files['zm'])
        wpthlp_dp1 = self.__getFallbackVar__('wpthlp_dp1', self.ncdf_files['zm'])
        wpthlp_sicl = self.__getFallbackVar__('wpthlp_sicl', self.ncdf_files['zm'])
        wpthlp_bt = self.__getFallbackVar__('wpthlp_bt', self.ncdf_files['zm'])
        wpthlp_ta = self.__getFallbackVar__('wpthlp_ta', self.ncdf_files['zm'])
        wpthlp_forcing = self.__getFallbackVar__('wpthlp_forcing', self.ncdf_files['zm'])
        wpthlp_bp = self.__getFallbackVar__('wpthlp_bp', self.ncdf_files['zm'])
        wpthlp_ma = self.__getFallbackVar__('wpthlp_ma', self.ncdf_files['zm'])
    ...
    def getWprtpResidual(self):
        ...
        '''
        z_ncdf = self.__getFallbackVar__('altitude', self.ncdf_files['zm'])
        wprtp_mfl = self.__getFallbackVar__('wprtp_mfl', self.ncdf_files['zm'])
        wprtp_cl = self.__getFallbackVar__('wprtp_cl', self.ncdf_files['zm'])
        wprtp_tp = self.__getFallbackVar__('wprtp_tp', self.ncdf_files['zm'])
        wprtp_ac = self.__getFallbackVar__('wprtp_ac', self.ncdf_files['zm'])
        wprtp_pr1 = self.__getFallbackVar__('wprtp_pr1', self.ncdf_files['zm'])
        wprtp_pr3 = self.__getFallbackVar__('wprtp_pr3', self.ncdf_files['zm'])
        wprtp_pr2 = self.__getFallbackVar__('wprtp_pr2', self.ncdf_files['zm'])
        wprtp_dp1 = self.__getFallbackVar__('wprtp_dp1', self.ncdf_files['zm'])
        wprtp_sicl = self.__getFallbackVar__('wprtp_sicl', self.ncdf_files['zm'])
        wprtp_bt = self.__getFallbackVar__('wprtp_bt', self.ncdf_files['zm'])
        wprtp_ta = self.__getFallbackVar__('wprtp_ta', self.ncdf_files['zm'])
        wprtp_forcing = self.__getFallbackVar__('wprtp_forcing', self.ncdf_files['zm'])
        wprtp_bp = self.__getFallbackVar__('wprtp_bp', self.ncdf_files['zm'])
        wprtp_ma = self.__getFallbackVar__('wprtp_ma', self.ncdf_files['zm'])
        wprtp_pd = self.__getFallbackVar__('wprtp_pd', self.ncdf_files['zm'])
    ...
    def getWp2Residual(self):
        ...
        '''
        z_ncdf = self.__getFallbackVar__('altitude', self.ncdf_files['zm'])
        wp2_sf = self.__getFallbackVar__('wp2_sf', self.ncdf_files['zm'])
        wp2_cl = self.__getFallbackVar__('wp2_cl', self.ncdf_files['zm'])
        wp2_ac = self.__getFallbackVar__('wp2_ac', self.ncdf_files['zm'])
        wp2_pr1 = self.__getFallbackVar__('wp2_pr1', self.ncdf_files['zm'])
        wp2_pr3 = self.__getFallbackVar__('wp2_pr3', self.ncdf_files['zm'])
        wp2_pr2 = self.__getFallbackVar__('wp2_pr2', self.ncdf_files['zm'])
        wp2_dp1 = self.__getFallbackVar__('wp2_dp1', self.ncdf_files['zm'])
        wp2_dp2 = self.__getFallbackVar__('wp2_dp2', self.ncdf_files['zm'])
        wp2_bt = self.__getFallbackVar__('wp2_bt', self.ncdf_files['zm'])
        wp2_ta = self.__getFallbackVar__('wp2_ta', self.ncdf_files['zm'])
        wp2_splat = self.__getFallbackVar__('wp2_splat', self.ncdf_files['zm'])
        wp2_bp = self.__getFallbackVar__('wp2_bp', self.ncdf_files['zm'])
        wp2_ma = self.__getFallbackVar__('wp2_ma', self.ncdf_files['zm'])
        wp2_pd = self.__getFallbackVar__('wp2_pd', self.ncdf_files['zm'])
    ...
    def getWp3Residual(self):
        ...
        '''
        z_ncdf = self.__getFallbackVar__('altitude', self.ncdf_files['zt'])
        wp3_bp1 = self.__getFallbackVar__('wp3_bp1', self.ncdf_files['zt'])
        wp3_bp2 = self.__getFallbackVar__('wp3_bp2', self.ncdf_files['zt'])
        wp3_cl = self.__getFallbackVar__('wp3_cl', self.ncdf_files['zt'])
        wp3_ac = self.__getFallbackVar__('wp3_ac', self.ncdf_files['zt'])
        wp3_pr1 = self.__getFallbackVar__('wp3_pr1', self.ncdf_files['zt'])
        wp3_pr3 = self.__getFallbackVar__('wp3_pr3', self.ncdf_files['zt'])
        wp3_pr2 = self.__getFallbackVar__('wp3_pr2', self.ncdf_files['zt'])
        wp3_dp1 = self.__getFallbackVar__('wp3_dp1', self.ncdf_files['zt'])
        wp3_bt = self.__getFallbackVar__('wp3_bt', self.ncdf_files['zt'])
        wp3_ta = self.__getFallbackVar__('wp3_ta', self.ncdf_files['zt'])
        wp3_splat = self.__getFallbackVar__('wp3_splat', self.ncdf_files['zt'])
        wp3_ma = self.__getFallbackVar__('wp3_ma', self.ncdf_files['zt'])
        wp3_tp = self.__getFallbackVar__('wp3_tp', self.ncdf_files['zt'])
    ...
    def getThlp2Residual(self):
        ...
        '''
        z_ncdf = self.__getFallbackVar__('altitude', self.ncdf_files['zm'])
        thlp2_cl = self.__getFallbackVar__('thlp2_cl', self.ncdf_files['zm'])
        thlp2_dp2 = self.__getFallbackVar__('thlp2_dp2', self.ncdf_files['zm'])
        thlp2_forcing = self.__getFallbackVar__('thlp2_forcing', self.ncdf_files['zm'])
        thlp2_sf = self.__getFallbackVar__('thlp2_sf', self.ncdf_files['zm'])
        thlp2_dp1 = self.__getFallbackVar__('thlp2_dp1', self.ncdf_files['zm'])
        thlp2_bt = self.__getFallbackVar__('thlp2_bt', self.ncdf_files['zm'])
        thlp2_ta = self.__getFallbackVar__('thlp2_ta', self.ncdf_files['zm'])
        thlp2_pd = self.__getFallbackVar__('thlp2_pd', self.ncdf_files['zm'])
        thlp2_ma = self.__getFallbackVar__('thlp2_ma', self.ncdf_files['zm'])
        thlp2_tp = self.__getFallbackVar__('thlp2_tp', self.ncdf_files['zm'])
    ...
    def getRtp2Residual(self):
        ...
        '''
        z_ncdf = self.__getFallbackVar__('altitude', self.ncdf_files['zm'])
        rtp2_cl = self.__getFallbackVar__('rtp2_cl', self.ncdf_files['zm'])
        rtp2_dp2 = self.__getFallbackVar__('rtp2_dp2', self.ncdf_files['zm'])
        rtp2_forcing = self.__getFallbackVar__('rtp2_forcing', self.ncdf_files['zm'])
        rtp2_sf = self.__getFallbackVar__('rtp2_sf', self.ncdf_files['zm'])
        rtp2_dp1 = self.__getFallbackVar__('rtp2_dp1', self.ncdf_files['zm'])
        rtp2_bt = self.__getFallbackVar__('rtp2_bt', self.ncdf_files['zm'])
        rtp2_ta = self.__getFallbackVar__('rtp2_ta', self.ncdf_files['zm'])
        rtp2_pd = self.__getFallbackVar__('rtp2_pd', self.ncdf_files['zm'])
        rtp2_ma = self.__getFallbackVar__('rtp2_ma', self.ncdf_files['zm'])
        rtp2_tp = self.__getFallbackVar__('rtp2_tp', self.ncdf_files['zm'])
    ...
    def getRtpthlpResidual(self):
        ...
        '''
        z_ncdf = self.__getFallbackVar__('altitude', self.ncdf_files['zm'])
        rtpthlp_cl = self.__getFallbackVar__('rtpthlp_cl', self.ncdf_files['zm'])
        rtpthlp_dp2 = self.__getFallbackVar__('rtpthlp_dp2', self.ncdf_files['zm'])
        rtpthlp_forcing = self.__getFallbackVar__('rtpthlp_forcing', self.ncdf_files['zm'])
        rtpthlp_sf = self.__getFallbackVar__('rtpthlp_sf', self.ncdf_files['zm'])
        rtpthlp_dp1 = self.__getFallbackVar__('rtpthlp_dp1', self.ncdf_files['zm'])
        rtpthlp_bt = self.__getFallbackVar__('rtpthlp_bt', self.ncdf_files['zm'])
        rtpthlp_ta = self.__getFallbackVar__('rtpthlp_ta', self.ncdf_files['zm'])
        rtpthlp_tp2 = self.__getFallbackVar__('rtpthlp_tp2', self.ncdf_files['zm'])
        rtpthlp_ma = self.__getFallbackVar__('rtpthlp_ma', self.ncdf_files['zm'])
        rtpthlp_tp1 = self.__getFallbackVar__('rtpthlp_tp1', self.ncdf_files['zm'])
    ...
    def getUpwpResidual(self):
        ...
        '''
        z_ncdf = self.__getFallbackVar__('altitude', self.ncdf_files['zm'])
        upwp_cl = self.__getFallbackVar__('upwp_cl', self.ncdf_files['zm'])
        upwp_tp = self.__getFallbackVar__('upwp_tp', self.ncdf_files['zm'])
        upwp_ac = self.__getFallbackVar__('upwp_ac', self.ncdf_files['zm'])
        upwp_bp = self.__getFallbackVar__('upwp_bp', self.ncdf_files['zm'])
        upwp_dp1 = self.__getFallbackVar__('upwp_dp1', self.ncdf_files['zm'])
        upwp_bt = self.__getFallbackVar__('upwp_bt', self.ncdf_files['zm'])
        upwp_ta = self.__getFallbackVar__('upwp_ta', self.ncdf_files['zm'])
        upwp_pr1 = self.__getFallbackVar__('upwp_pr1', self.ncdf_files['zm'])
        upwp_pr2 = self.__getFallbackVar__('upwp_pr2', self.ncdf_files['zm'])
        upwp_pr3 = self.__getFallbackVar__('upwp_pr3', self.ncdf_files['zm'])
        upwp_pr4 = self.__getFallbackVar__('upwp_pr4', self.ncdf_files['zm'])
        upwp_mfl = self.__getFallbackVar__('upwp_mfl', self.ncdf_files['zm'])
        upwp_ma = self.__getFallbackVar__('upwp_ma', self.ncdf_files['zm'])
    ...
    def getVpwpResidual(self):
        ...
        '''
        z_ncdf = self.__getFallbackVar__('altitude', self.ncdf_files['zm'])
        vpwp_cl = self.__getFallbackVar__('vpwp_cl', self.ncdf_files['zm'])
        vpwp_tp = self.__getFallbackVar__('vpwp_tp', self.ncdf_files['zm'])
        vpwp_ac = self.__getFallbackVar__('vpwp_ac', self.ncdf_files['zm'])
        vpwp_bp = self.__getFallbackVar__('vpwp_bp', self.ncdf_files['zm'])
        vpwp_dp1 = self.__getFallbackVar__('vpwp_dp1', self.ncdf_files['zm'])
        vpwp_bt = self.__getFallbackVar__('vpwp_bt', self.ncdf_files['zm'])
        vpwp_ta = self.__getFallbackVar__('vpwp_ta', self.ncdf_files['zm'])
        vpwp_pr1 = self.__getFallbackVar__('vpwp_pr1', self.ncdf_files['zm'])
        vpwp_pr2 = self.__getFallbackVar__('vpwp_pr2', self.ncdf_files['zm'])
        vpwp_pr3 = self.__getFallbackVar__('vpwp_pr3', self.ncdf_files['zm'])
        vpwp_pr4 = self.__getFallbackVar__('vpwp_pr4', self.ncdf_files['zm'])
        vpwp_mfl = self.__getFallbackVar__('vpwp_mfl', self.ncdf_files['zm'])
        vpwp_ma = self.__getFallbackVar__('vpwp_ma', self.ncdf_files['zm'])
