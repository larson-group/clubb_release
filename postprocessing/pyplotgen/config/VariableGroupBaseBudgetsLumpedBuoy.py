...
class VariableGroupBaseBudgetsLumpedBuoy(VariableGroup):
    """
    ...
    def __init__(self, case, clubb_datasets=None, sam_benchmark_dataset=None, coamps_benchmark_dataset=None, r408_dataset=None,
        ...
        wpthlp_budget_lines = [
            ...
            {'var_names': ['wpthlp_bp_pr3', self.calcWpthlpLumpedBuoy], 'legend_label': 'wpthlp_bp_pr3'},
        ...
        wprtp_budget_lines = [
            ...
            {'var_names': ['wprtp_bp_pr3', self.calcWprtpLumpedBuoy], 'legend_label': 'wprtp_bp_pr3'},
    ...
    def calcWpthlpLumpedBuoy(self, dataset_override=None):
        '''
        '''
        # z,z, dataset = self.getVarForCalculations('altitude', dataset_override)
        wpthlp_bp, indep, dataset = self.getVarForCalculations('wpthlp_bp', dataset_override)
        wpthlp_pr3, indep, dataset = self.getVarForCalculations('wpthlp_pr3', dataset)

        output_data = wpthlp_bp + wpthlp_pr3
    ...
    def calcWprtpLumpedBuoy(self, dataset_override=None):
        '''
        '''
        # z,z, dataset = self.getVarForCalculations('altitude', dataset_override)
        wprtp_bp, indep, dataset = self.getVarForCalculations('wprtp_bp', dataset_override)
        wprtp_pr3, indep, dataset = self.getVarForCalculations('wprtp_pr3', dataset)

        output_data = wprtp_bp + wprtp_pr3
