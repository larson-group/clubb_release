...
ARM = {'name': 'arm',
       ...
       'sam_benchmark_file': {
           'sam_benchmark': SAM_BENCHMARK_OUTPUT_ROOT + "/JULY_2017/ARM_96x96x110/GCSSARM_96x96x110_67m_40m_1s.nc"},
...
DYCOMS2_RF02_DO = {'name': 'dycoms2_rf02_do',
                   ...
                   'coamps_benchmark_file': None,
                   'clubb_r408_benchmark_file': {
                       'zm': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/dycoms2_rf02_do_zm.nc',
...
DYCOMS2_RF02_ND = {'name': 'dycoms2_rf02_nd',
                   ...
                   'coamps_benchmark_file': None,
                   'clubb_r408_benchmark_file': {
                       'zm': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/dycoms2_rf02_nd_zm.nc',
...
DYCOMS2_RF02_DS_RESTART = {'name': 'dycoms2_rf02_ds_restart',
                           ...
                           'coamps_benchmark_file': None,
                           'clubb_r408_benchmark_file': {
                               'zm': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/dycoms2_rf02_ds_zm.nc',
...
DYCOMS2_RF02_SO = {'name': 'dycoms2_rf02_so',
                   ...
                   'coamps_benchmark_file': None,
                   'clubb_r408_benchmark_file': {
                       'zm': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/dycoms2_rf02_so_zm.nc',
...
LBA = {'name': 'lba',
       ...
       'wrf_file': None,
       'silhs_file': {'silhs': '/lba_nl_lh_sample_points_2D.nc'},
       'var_groups': [VariableGroupBase, VariableGroupLiquidMP, VariableGroupIceMP, VariableGroupWs]}
