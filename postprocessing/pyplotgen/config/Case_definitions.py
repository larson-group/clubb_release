...
**Case Definition values explained**:
    ...
    *name*: must be the same as the filename without the extension.
        E.g. to use lba_stats.nc the case's name must be 'lba'.
...
HEIGHT_VAR_NAMES = ['z', 'Z3', 'altitude', 'lev', 'CSP_Zm', 'CSP_Z8Wm',
                    'zt', 'zm', 'lh_zt', 'rad_zt', 'rad_zm']  # CSP_* added for WRF-LASSO cases
...
ARM = {'name': 'arm',
       ...
       'clubb_file': {'zm': clubb_output_root + '/arm_stats.nc',
                      'zt': clubb_output_root + '/arm_stats.nc',
                      'sfc': clubb_output_root + '/arm_stats.nc'},
       ...
       'wrf_file': {'zm': wrf_output_root + "/arm_stats_wrf.nc",
                    'zt': wrf_output_root + "/arm_stats_wrf.nc",
                    'sfc': wrf_output_root + "/arm_stats_wrf.nc"
                    },
...
ARM_97 = {'name': 'arm_97',
          ...
          'clubb_file': {'zm': clubb_output_root + '/arm_97_stats.nc',
                         'zt': clubb_output_root + '/arm_97_stats.nc',
                         'sfc': clubb_output_root + '/arm_97_stats.nc',
                         'subcolumns': clubb_output_root + '/arm_97_stats.nc'},
...
ASTEX_A209 = {'name': 'astex_a209',
              ...
              'clubb_file': {'zm': clubb_output_root + '/astex_a209_stats.nc',
                             'zt': clubb_output_root + '/astex_a209_stats.nc',
                             'sfc': clubb_output_root + '/astex_a209_stats.nc'},
              'coamps_benchmark_file': None,
              'wrf_benchmark_file': None,
              'clubb_r408_benchmark_file': None,
              'clubb_hoc_benchmark_file': None,
...
ATEX = {'name': 'atex',
        ...
        'blacklisted_vars': [],
        'sam_benchmark_file': None,
        'clubb_file': {'zm': clubb_output_root + '/atex_stats.nc',
                       'zt': clubb_output_root + '/atex_stats.nc',
                       'sfc': clubb_output_root + '/atex_stats.nc'},
        ...
        'sam_file': None,
        'wrf_file': {'zm': wrf_output_root + "/atex_stats_wrf.nc",
                     'zt': wrf_output_root + "/atex_stats_wrf.nc",
                     'sfc': wrf_output_root + "/atex_stats_wrf.nc"
                     },
        'var_groups': [VariableGroupBase, VariableGroupWs, VariableGroupLiquidMP, VariableGroupIceMP]}
...
ATEX_LONG = {'name': 'atex_long',
        ...
        'blacklisted_vars': [],
        'sam_benchmark_file': None,
        'clubb_file': {'zm': clubb_output_root + '/atex_long_stats.nc',
                       'zt': clubb_output_root + '/atex_long_stats.nc',
                       'sfc': clubb_output_root + '/atex_long_stats.nc'},
        'coamps_benchmark_file': None,
        'wrf_benchmark_file': None,
        'clubb_r408_benchmark_file': None,
        'clubb_hoc_benchmark_file': None,
        ...
        'sam_file': None,
        'wrf_file': {'zm': wrf_output_root + "/atex_long_stats_wrf.nc",
                     'zt': wrf_output_root + "/atex_long_stats_wrf.nc",
                     'sfc': wrf_output_root + "/atex_long_stats_wrf.nc"
                     },
        'var_groups': [VariableGroupBase, VariableGroupWs, VariableGroupLiquidMP, VariableGroupIceMP]}
...
BOMEX = {'name': 'bomex',
         ...
         'wrf_file': {'zm': wrf_output_root + '/bomex_stats_wrf.nc',
                      'zt': wrf_output_root + '/bomex_stats_wrf.nc',
                      'sfc': wrf_output_root + '/bomex_stats_wrf.nc'},
         'var_groups': [VariableGroupBase, VariableGroupWs]}
...
CGILS_S6 = {'name': 'cgils_s6',
            ...
            'clubb_file': {'zm': clubb_output_root + '/cgils_s6_stats.nc',
                           'zt': clubb_output_root + '/cgils_s6_stats.nc',
                           'sfc': clubb_output_root + '/cgils_s6_stats.nc'},
            'coamps_benchmark_file': None,
            'wrf_benchmark_file': None,
            'clubb_r408_benchmark_file': None,
            'clubb_hoc_benchmark_file': None,
...
CGILS_S11 = {'name': 'cgils_s11',
             ...
             'clubb_file': {'zm': clubb_output_root + '/cgils_s11_stats.nc',
                            'zt': clubb_output_root + '/cgils_s11_stats.nc',
                            'sfc': clubb_output_root + '/cgils_s11_stats.nc'},
             'coamps_benchmark_file': None,
             'wrf_benchmark_file': None,
             'clubb_r408_benchmark_file': None,
             'clubb_hoc_benchmark_file': None,
...
CGILS_S12 = {'name': 'cgils_s12',
             ...
             'clubb_file': {'zm': clubb_output_root + '/cgils_s12_stats.nc',
                            'zt': clubb_output_root + '/cgils_s12_stats.nc',
                            'sfc': clubb_output_root + '/cgils_s12_stats.nc'},
             'coamps_benchmark_file': None,
             'wrf_benchmark_file': None,
             'clubb_r408_benchmark_file': None,
             'clubb_hoc_benchmark_file': None,
...
CLEX9_NOV02 = {'name': 'clex9_nov02',
               ...
               'sam_benchmark_file': None,
               'clubb_file': {'zm': clubb_output_root + '/clex9_nov02_stats.nc',
                              'zt': clubb_output_root + '/clex9_nov02_stats.nc',
                              'sfc': clubb_output_root + '/clex9_nov02_stats.nc'},
...
CLEX9_OCT14 = {'name': 'clex9_oct14',
               ...
               'blacklisted_vars': ['Ngm'],
               'sam_benchmark_file': None,
               'clubb_file': {'zm': clubb_output_root + '/clex9_oct14_stats.nc',
                              'zt': clubb_output_root + '/clex9_oct14_stats.nc',
                              'sfc': clubb_output_root + '/clex9_oct14_stats.nc'},
...
DYCOMS2_RF01 = {'name': 'dycoms2_rf01',
                ...
                'clubb_file': {'zm': clubb_output_root + '/dycoms2_rf01_stats.nc',
                               'zt': clubb_output_root + '/dycoms2_rf01_stats.nc',
                               'sfc': clubb_output_root + '/dycoms2_rf01_stats.nc'},
                'coamps_benchmark_file': None,
                'wrf_benchmark_file': None,
...
DYCOMS2_RF01_FIXED_SST = {'name': 'dycoms2_rf01_fixed_sst',
                          ...
                          'clubb_file': {'zm': clubb_output_root + '/dycoms2_rf01_fixed_sst_stats.nc',
                                         'zt': clubb_output_root + '/dycoms2_rf01_fixed_sst_stats.nc',
                                         'sfc': clubb_output_root + '/dycoms2_rf01_fixed_sst_stats.nc'},
                          'coamps_benchmark_file': None,
                          'wrf_benchmark_file': None,
                          'clubb_r408_benchmark_file': None,
                          'clubb_hoc_benchmark_file': None,
...
DYCOMS2_RF02_DO = {'name': 'dycoms2_rf02_do',
                   ...
                   'clubb_file': {'zm': clubb_output_root + '/dycoms2_rf02_do_stats.nc',
                                  'zt': clubb_output_root + '/dycoms2_rf02_do_stats.nc',
                                  'sfc': clubb_output_root + '/dycoms2_rf02_do_stats.nc'},
                   'coamps_benchmark_file': None,
                   'wrf_benchmark_file': None,
...
DYCOMS2_RF02_DS = {'name': 'dycoms2_rf02_ds',
                   ...
                   'clubb_file': {'zm': clubb_output_root + '/dycoms2_rf02_ds_stats.nc',
                                  'zt': clubb_output_root + '/dycoms2_rf02_ds_stats.nc',
                                  'sfc': clubb_output_root + '/dycoms2_rf02_ds_stats.nc'},
                   'coamps_benchmark_file': None,
                   'wrf_benchmark_file': None,
                   'clubb_r408_benchmark_file': None,
...
DYCOMS2_RF02_ND = {'name': 'dycoms2_rf02_nd',
                   ...
                   'clubb_file': {'zm': clubb_output_root + '/dycoms2_rf02_nd_stats.nc',
                                  'zt': clubb_output_root + '/dycoms2_rf02_nd_stats.nc',
                                  'sfc': clubb_output_root + '/dycoms2_rf02_nd_stats.nc'},
                   'coamps_benchmark_file': None,
                   'wrf_benchmark_file': None,
...
DYCOMS2_RF02_DS_RESTART = {'name': 'dycoms2_rf02_ds_restart',
                           ...
                           'sam_benchmark_file': {'sam_benchmark': SAM_BENCHMARK_OUTPUT_ROOT +
                                                 "/JULY_2017/DYCOMS_RF02_128x128x96_dr_sed/DYCOMS_RF02_128x128x96_dr_sed.nc"},
                           'clubb_file': {'zm': clubb_output_root + '/dycoms2_rf02_ds_restart_stats.nc',
                                          'zt': clubb_output_root + '/dycoms2_rf02_ds_restart_stats.nc',
                                          'sfc': clubb_output_root + '/dycoms2_rf02_ds_restart_stats.nc'},
                           'coamps_benchmark_file': None,
                           'wrf_benchmark_file': None,
...
DYCOMS2_RF02_SO = {'name': 'dycoms2_rf02_so',
                   ...
                   'clubb_file': {'zm': clubb_output_root + '/dycoms2_rf02_so_stats.nc',
                                  'zt': clubb_output_root + '/dycoms2_rf02_so_stats.nc',
                                  'sfc': clubb_output_root + '/dycoms2_rf02_so_stats.nc'},
                   'coamps_benchmark_file': None,
                   'wrf_benchmark_file': None,
...
FIRE = {'name': 'fire',
        ...
        'blacklisted_vars': [],
        'sam_benchmark_file': None,
        'clubb_file': {'zm': clubb_output_root + '/fire_stats.nc',
                       'zt': clubb_output_root + '/fire_stats.nc',
                       'sfc': clubb_output_root + '/fire_stats.nc'},
        ...
        'cam_file': None,
        'sam_file': None,
        'wrf_file': {'zm': wrf_output_root + "/fire_stats_wrf.nc",
                     'zt': wrf_output_root + "/fire_stats_wrf.nc",
                     'sfc': wrf_output_root + "/fire_stats_wrf.nc"
                     },
        'var_groups': [VariableGroupBase, VariableGroupWs]}
...
GABLS2 = {'name': 'gabls2',
          ...
          'sam_benchmark_file': None,
          'clubb_file': {'zm': clubb_output_root + '/gabls2_stats.nc',
                         'zt': clubb_output_root + '/gabls2_stats.nc',
                         'sfc': clubb_output_root + '/gabls2_stats.nc'},
...
GABLS3 = {'name': 'gabls3',
          ...
          'blacklisted_vars': [],
          'sam_benchmark_file': None,
          'clubb_file': {'zm': clubb_output_root + '/gabls3_stats.nc',
                         'zt': clubb_output_root + '/gabls3_stats.nc',
                         'sfc': clubb_output_root + '/gabls3_stats.nc'},
          'coamps_benchmark_file': None,
          'wrf_benchmark_file': None,
          'clubb_r408_benchmark_file': None,
          'clubb_hoc_benchmark_file': None,
...
GABLS3_NIGHT = {'name': 'gabls3_night',
                ...
                'clubb_file': {'zm': clubb_output_root + '/gabls3_night_stats.nc',
                               'zt': clubb_output_root + '/gabls3_night_stats.nc',
                               'sfc': clubb_output_root + '/gabls3_night_stats.nc'},
                'coamps_benchmark_file': None,
                'wrf_benchmark_file': None,
                'clubb_r408_benchmark_file': None,
                'clubb_hoc_benchmark_file': None,
...
JUN25_ALTOCU = {'name': 'jun25_altocu',
                ...
                'sam_benchmark_file': None,
                'clubb_file': {'zm': clubb_output_root + '/jun25_altocu_stats.nc',
                               'zt': clubb_output_root + '/jun25_altocu_stats.nc',
                               'sfc': clubb_output_root + '/jun25_altocu_stats.nc'},
...
LBA = {'name': 'lba',
       ...
       'clubb_file': {'zm': clubb_output_root + '/lba_stats.nc',
                      'zt': clubb_output_root + '/lba_stats.nc',
                      'sfc': clubb_output_root + '/lba_stats.nc',
                      'subcolumns': clubb_output_root + '/lba_stats.nc'},
       'coamps_benchmark_file': None,
       'wrf_benchmark_file': None,
       'clubb_r408_benchmark_file': None,
       'clubb_hoc_benchmark_file': None,
...
MC3E = {'name': 'mc3e',
        ...
        'clubb_file': {'zm': clubb_output_root + '/mc3e_stats.nc',
                       'zt': clubb_output_root + '/mc3e_stats.nc',
                       'sfc': clubb_output_root + '/mc3e_stats.nc',
                       'subcolumns': clubb_output_root + '/mc3e_stats.nc'},
        'coamps_benchmark_file': None,
        'wrf_benchmark_file': None,
        'clubb_r408_benchmark_file': None,
        'clubb_hoc_benchmark_file': None,
...
MPACE_A = {'name': 'mpace_a',
           ...
           'clubb_file': {'zm': clubb_output_root + '/mpace_a_stats.nc',
                          'zt': clubb_output_root + '/mpace_a_stats.nc',
                          'sfc': clubb_output_root + '/mpace_a_stats.nc'},
           'coamps_benchmark_file': None,
           'wrf_benchmark_file': None,
           'clubb_r408_benchmark_file': None,
           'clubb_hoc_benchmark_file': None,
...
MPACE_B = {'name': 'mpace_b',
           ...
           'sam_benchmark_file': None,
           'clubb_file': {'zm': clubb_output_root + '/mpace_b_stats.nc',
                          'zt': clubb_output_root + '/mpace_b_stats.nc',
                          'sfc': clubb_output_root + '/mpace_b_stats.nc'},
...
MPACE_B_SILHS = {'name': 'mpace_b_silhs',
                 ...
                 'blacklisted_vars': ['Ngm', 'wpNrp'],
                 'sam_benchmark_file': None,
                 'clubb_file': {'zm': clubb_output_root + '/mpace_b_silhs_stats.nc',
                                'zt': clubb_output_root + '/mpace_b_silhs_stats.nc',
                                'sfc': clubb_output_root + '/mpace_b_silhs_stats.nc',
                                'subcolumns': clubb_output_root + '/mpace_b_silhs_stats.nc'},
                 'coamps_benchmark_file': {'sm': COAMPS_BENCHMARK_OUTPUT_ROOT + "/mpace_b_coamps_sm.nc",
                                           'sw': COAMPS_BENCHMARK_OUTPUT_ROOT + "/mpace_b_coamps_sw.nc"},
                 'wrf_benchmark_file': None,
                 'clubb_r408_benchmark_file': None,
...
NOV11_ALTOCU = {'name': 'nov11_altocu',
                ...
                'blacklisted_vars': ['Ngm'],
                'sam_benchmark_file': None,
                'clubb_file': {'zm': clubb_output_root + '/nov11_altocu_stats.nc',
                               'zt': clubb_output_root + '/nov11_altocu_stats.nc',
                               'sfc': clubb_output_root + '/nov11_altocu_stats.nc'},
...
RICO = {'name': 'rico',
        ...
        'clubb_file': {'zm': clubb_output_root + '/rico_stats.nc',
                       'zt': clubb_output_root + '/rico_stats.nc',
                       'sfc': clubb_output_root + '/rico_stats.nc'},
...
RICO_SILHS = {'name': 'rico_silhs',
              ...
              'sam_benchmark_file': {'sam_benchmark': SAM_BENCHMARK_OUTPUT_ROOT +
                                    "/JULY_2017/RICO_256x256x100_drizzle/RICO_256x256x100_drizzle.nc"},
              'clubb_file': {'zm': clubb_output_root + '/rico_silhs_stats.nc',
                             'zt': clubb_output_root + '/rico_silhs_stats.nc',
                             'sfc': clubb_output_root + '/rico_silhs_stats.nc',
                             'subcolumns': clubb_output_root + '/rico_silhs_stats.nc'},
              'coamps_benchmark_file': {'sm': COAMPS_BENCHMARK_OUTPUT_ROOT + "/rico_coamps_sm.nc",
                                        'sw': COAMPS_BENCHMARK_OUTPUT_ROOT + "/rico_coamps_sw.nc"},
              'wrf_benchmark_file': None,
              'clubb_r408_benchmark_file': None,
...
NEUTRAL = {'name': 'neutral',
          ...
          'clubb_file': {'zm': clubb_output_root + '/neutral_stats.nc',
                         'zt': clubb_output_root + '/neutral_stats.nc',
                         'sfc': clubb_output_root + '/neutral_stats.nc'},
          'coamps_benchmark_file': None,
          'wrf_benchmark_file': None,
          'clubb_r408_benchmark_file': None,
          'clubb_hoc_benchmark_file': None,
...
TWP_ICE = {'name': 'twp_ice',
           ...
           'clubb_file': {'zm': clubb_output_root + '/twp_ice_stats.nc',
                          'zt': clubb_output_root + '/twp_ice_stats.nc',
                          'sfc': clubb_output_root + '/twp_ice_stats.nc',
                          'subcolumns': clubb_output_root + '/twp_ice_stats.nc'},
           'coamps_benchmark_file': None,
           'wrf_benchmark_file': None,
           'clubb_r408_benchmark_file': None,
           'clubb_hoc_benchmark_file': None,
...
WANGARA = {'name': 'wangara',
           ...
           'clubb_file': {'zm': clubb_output_root + '/wangara_stats.nc',
                          'zt': clubb_output_root + '/wangara_stats.nc',
                          'sfc': clubb_output_root + '/wangara_stats.nc'},
           ...
           'cam_file': None,
           'sam_file': None,
           'wrf_file': {'zm': wrf_output_root + "/wangara_stats_wrf.nc",
                        'zt': wrf_output_root + "/wangara_stats_wrf.nc",
                        'sfc': wrf_output_root + "/wangara_stats_wrf.nc"
                        },
           'var_groups': [VariableGroupBase, VariableGroupWs]}
