...
ARM = {'name': 'arm',
       ...
       'sam_benchmark_file': SAM_BENCHMARK_OUTPUT_ROOT + "/JULY_2017/ARM_96x96x110/GCSSARM_96x96x110_67m_40m_1s.nc",
       ...
       'clubb_r408_file': {'zm': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/arm_zm.nc',
                     'zt': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/arm_zt.nc',
                     'sfc': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/arm_sfc.nc'},
       'clubb_hoc_file': {'zm': HOC_OUTPUT_ROOT + '/arm_zm.nc',
...
ARM_97 = {'name': 'arm_97',
          ...
          'sam_benchmark_file': SAM_BENCHMARK_OUTPUT_ROOT + "/ARM97_r1315_128x128x128_1km_Morrison/ARM9707.nc",
...
ATEX = {'name': 'atex',
        ...
        'clubb_r408_file': {'zm': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/atex_zm.nc',
                      'zt': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/atex_zt.nc',
                      'sfc': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/atex_sfc.nc'},
        'clubb_hoc_file': {'zm': HOC_OUTPUT_ROOT + '/atex_zm.nc',
...
BOMEX = {'name': 'bomex',
         ...
         'blacklisted_vars': [],
         'sam_benchmark_file': SAM_BENCHMARK_OUTPUT_ROOT + "/JULY_2017/BOMEX_64x64x75/BOMEX_64x64x75_100m_40m_1s.nc",
         ...
         'clubb_r408_file': {'zm': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/bomex_zm.nc',
                       'zt': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/bomex_zt.nc',
                       'sfc': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/bomex_sfc.nc'},
         'clubb_hoc_file': {'zm': HOC_OUTPUT_ROOT + '/bomex_zm.nc',
...
CGILS_S6 = {'name': 'cgils_s6',
            ...
            'sam_benchmark_file': SAM_BENCHMARK_OUTPUT_ROOT +
...
DYCOMS2_RF01 = {'name': 'dycoms2_rf01',
                ...
                'blacklisted_vars': [],
                'sam_benchmark_file': SAM_BENCHMARK_OUTPUT_ROOT + "/JULY_2017/DYCOMS_RF01_96x96x320/DYCOMS_RF01_96x96x320.nc",
                ...
                'coamps_benchmark_file': None,
                'clubb_r408_file': {'zm': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/dycoms2_rf01_zm.nc',
                ...
                'clubb_hoc_file': {'zm': HOC_OUTPUT_ROOT + '/dycoms2_rf01_zm.nc',
...
DYCOMS2_RF02_DO = {'name': 'dycoms2_rf02_do',
                   ...
                   'coamps_benchmark_file': None,
                   'clubb_r408_file': {'zm': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/dycoms2_rf02_do_zm.nc',
                   ...
                   'clubb_hoc_file': {'zm': HOC_OUTPUT_ROOT + '/dycoms2_rf02_do_zm.nc',
...
DYCOMS2_RF02_DS = {'name': 'dycoms2_rf02_ds',
                   ...
                   'coamps_benchmark_file': None,
                   'clubb_r408_file': None,
                   'clubb_hoc_file': {'zm': HOC_OUTPUT_ROOT + '/dycoms2_rf02_ds_zm.nc',
...
DYCOMS2_RF02_ND = {'name': 'dycoms2_rf02_nd',
                   ...
                   'coamps_benchmark_file': None,
                   'clubb_r408_file': {'zm': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/dycoms2_rf02_nd_zm.nc',
                   ...
                   'clubb_hoc_file': {'zm': HOC_OUTPUT_ROOT + '/dycoms2_rf02_nd_zm.nc',
...
DYCOMS2_RF02_DS_RESTART = {'name': 'dycoms2_rf02_ds_restart',
                           ...
                           'coamps_benchmark_file': None,
                           'clubb_r408_file': {'zm': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/dycoms2_rf02_ds_zm.nc',
...
DYCOMS2_RF02_SO = {'name': 'dycoms2_rf02_so',
                   ...
                   'coamps_benchmark_file': None,
                   'clubb_r408_file': {'zm': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/dycoms2_rf02_so_zm.nc',
                   ...
                   'clubb_hoc_file': {'zm': HOC_OUTPUT_ROOT + '/dycoms2_rf02_so_zm.nc',
...
FIRE = {'name': 'fire',
        ...
        'clubb_r408_file': {'zm': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/fire_zm.nc',
                      'zt': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/fire_zt.nc',
                      'sfc': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/fire_sfc.nc'},
        'clubb_hoc_file': {'zm': HOC_OUTPUT_ROOT + "/fire_zm.nc",
...
GABLS2 = {'name': 'gabls2',
          ...
          'coamps_benchmark_file': {'sfc': COAMPS_BENCHMARK_OUTPUT_ROOT + "/gabls2_coamps_sfc.nc",
                             'sm': COAMPS_BENCHMARK_OUTPUT_ROOT + "/gabls2_coamps_sm.nc",
...
GABLS3_NIGHT = {'name': 'gabls3_night',
                ...
                'blacklisted_vars': [],
                'sam_benchmark_file': SAM_BENCHMARK_OUTPUT_ROOT + "/SAM6.6/GABLS3_NIGHT/gabls3_night.nc",
...
MC3E = {'name': 'mc3e',
        ...
        'sam_benchmark_file': SAM_BENCHMARK_OUTPUT_ROOT + "/MC3E_r1359_128x128x128_1km_Morrison/MC3E.nc",
...
MPACE_A = {'name': 'mpace_a',
           ...
           'sam_benchmark_file': SAM_BENCHMARK_OUTPUT_ROOT + "/SAM6.6/MPACE_A/MPACE_A_128x128x69_morr_CEM.nc",
...
NOV11_ALTOCU = {'name': 'nov11_altocu',
                ...
                'clubb_r408_file': {'zm': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/nov11_altocu_zm.nc',
                ...
                'clubb_hoc_file': {'zm': HOC_OUTPUT_ROOT + '/nov11_altocu_zm.nc',
...
RICO = {'name': 'rico',
        ...
        'blacklisted_vars': [],
        'sam_benchmark_file': SAM_BENCHMARK_OUTPUT_ROOT + "/JULY_2017/RICO_256x256x100_drizzle/RICO_256x256x100_drizzle.nc",
...
TWP_ICE = {'name': 'twp_ice',
           ...
           'blacklisted_vars': ['rtp3', 'Skrt_zt', 'Skthl_zt', 'rtpthvp', 'thlpthvp', 'wprrp', 'wpNrp'],
           'sam_benchmark_file': SAM_BENCHMARK_OUTPUT_ROOT + "/TWP_ICE_r1315_128x128x128_1km_Morrison/TWP_ICE.nc",
...
WANGARA = {'name': 'wangara',
           ...
           'clubb_r408_file': {'zm': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/wangara_zm.nc',
                         'zt': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/wangara_zt.nc',
                         'sfc': R408_OUTPUT_ROOT + '/Chris_Golaz_best_ever/wangara_sfc.nc'},
           'clubb_hoc_file': {'zm': HOC_OUTPUT_ROOT + '/wangara_zm.nc',
