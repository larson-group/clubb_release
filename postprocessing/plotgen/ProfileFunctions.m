classdef ProfileFunctions
	...
	methods(Static)
		...
		function setTitleWithSize ( graphTitle, fontSize )
			hold off
		...
		function setAxisLabelsWithSize ( xLabel, yLabel, fontSize)
			hold off
		...
		function setAxisWithSize ( minVal, maxVal, startHeight, endHeight, fontSize )
			hold off
