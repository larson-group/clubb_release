...
if __name__ == "__main__":
    import sys
    sys.exit("Module(FILE): OutputWriter.py is used with plotgen to generate the html file")
...
<br />
    ...
    OutputWriter.writeSubHtml(FILE, text)
...
def writeWrfHeader(FILE):
    OutputWriter.writeSubHeader(FILE, "WRF_CLUBB runs use a 100-km horizontal grid spacing, 3x3 grid columns, and a 60-s timestep.")
...
def writeGfdlHeader(FILE):
    OutputWriter.writeSubHeader(FILE, "GFDL-SCM-CLUBB and CLUBB-standalone runs use a 10-min timestep with 48 levels")
...
def writeFooter(FILE):
	...
	<div align="CENTER">
		<font size="-2">
		Copyright &#169; 2014 Larson Group. All rights reserved. 
		</font>
	</div>
</body>
</html>
