...
wmzt_d_t_in_k(nzmax,:) = wm_array(nzmax,:) .* ( thlm_array(nzmax,:) - thlm_array(nzmax-1,:) ) / ( z(nzmax) - z(nzmax-1) );
...
wmzt_d_rvm(nzmax,:) = wm_array(nzmax,:) .* ( rvm_array(nzmax,:) - rvm_array(nzmax-1,:) ) / ( z(nzmax) - z(nzmax-1) );
