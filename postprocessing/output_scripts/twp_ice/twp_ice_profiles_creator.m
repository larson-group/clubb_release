...
q1_array = ((thlm_bt_array - (thlm_f_array - thlm_mc_array) + thlm_ma) .* exner_array) .* sec_per_day;
q2_array = (rtm_bt_array - (rtm_f_array - rtm_mc_array) + rtm_ma) .* (Lv / Cp) .* sec_per_day;
