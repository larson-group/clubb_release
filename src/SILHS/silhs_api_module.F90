...
contains
  ...
  subroutine generate_silhs_sample_api( &
    ...
    !   Manage the OpenACC data region for the sampling implementation.
  ...
  subroutine clip_transform_silhs_output_api( &
    ...
    ! Description:
    !   Compute clipped SILHS sample fields for all model columns, including
    !   ngrdcol=1, within the required OpenACC data region.
