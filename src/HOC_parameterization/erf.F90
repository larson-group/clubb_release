! $Id: erf.F90,v 1.1 2008-07-22 16:04:23 faschinj Exp $
        module anl_erf
...
!       David Schanen,
!       UWM.
!       Change subroutine to a function, Changed formatting, and Changed
!       the save attribute to a parameter for some variables.
!
!       References:
!       William Cody,
