! $Id: output_netcdf.F90,v 1.1 2008-07-22 16:04:26 faschinj Exp $
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
       ...
       ! From open_grads.
       ! Must be for the case of a reversed grid as in COAMPS
       if ( ia <= iz ) then
         do k=1,iz-ia+1
...
!-----------------------------------------------------------------------
       subroutine define_netcdf( ncid, ia, iz, zgrid, day, month,  & 
