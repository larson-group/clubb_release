...
!-------------------------------------------------------------------------------
    ...
    call check_nan( pdf_params%corr_w_rt_1, "pdf_params%corr_w_rt_1", proc_name, err_code )
    call check_nan( pdf_params%corr_w_rt_2, "pdf_params%corr_w_rt_2", proc_name, err_code )
    call check_nan( pdf_params%corr_w_thl_1, "pdf_params%corr_w_thl_1", proc_name, err_code )
    call check_nan( pdf_params%corr_w_thl_2, "pdf_params%corr_w_thl_2", proc_name, err_code )
    call check_nan( pdf_params%corr_rt_thl_1, "pdf_params%corr_rt_thl_1", proc_name, err_code )
    call check_nan( pdf_params%corr_rt_thl_2, "pdf_params%corr_rt_thl_2", proc_name, err_code )
