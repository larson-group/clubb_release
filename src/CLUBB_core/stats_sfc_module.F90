...
!-----------------------------------------------------------------------
    ...
    do i = 1, stats_sfc%num_output_fields
      ...
      case ('soil_heat_flux')
        ...
        call stat_assign( var_index=stats_metadata%isoil_heat_flux, &
             var_name="soil_heat_flux", &
      ...
      case ('ustar')
        ...
        call stat_assign( var_index=stats_metadata%iustar, &
             var_name="ustar", &
      ...
      case ('veg_T_in_K')
        ...
        call stat_assign( var_index=stats_metadata%iveg_T_in_K, &
             var_name="veg_T_in_K", &
      ...
      case ('sfc_soil_T_in_K')
        ...
        call stat_assign( var_index=stats_metadata%isfc_soil_T_in_K, &
             var_name="sfc_soil_T_in_K", &
      ...
      case ('deep_soil_T_in_K')
        ...
        call stat_assign( var_index=stats_metadata%ideep_soil_T_in_K, &
             var_name="deep_soil_T_in_K", &
      ...
      case ('lh')
        ...
        call stat_assign( var_index=stats_metadata%ilh, &
             var_name="lh", &
      ...
      case ('sh')
        ...
        call stat_assign( var_index=stats_metadata%ish, &
             var_name="sh", &
      ...
      case ('cc')
        ...
        call stat_assign( var_index=stats_metadata%icc, &
             var_name="cc", &
             var_description="cc, Cloud cover", &
             var_units="count", l_silhs=.false., grid_kind=stats_sfc )
        k = k + 1

      case ('lwp')
        stats_metadata%ilwp = k
        call stat_assign( var_index=stats_metadata%ilwp, &
             var_name="lwp", &
      ...
      case ('vwp')
        ...
        call stat_assign( var_index=stats_metadata%ivwp, &
             var_name="vwp", &
      ...
      case ('iwp')
        ...
        call stat_assign( var_index=stats_metadata%iiwp, &
             var_name="iwp", &
      ...
      case ('swp')
        ...
        call stat_assign( var_index=stats_metadata%iswp, &
             var_name="swp", &
      ...
      case ('z_cloud_base')
        ...
        call stat_assign( var_index=stats_metadata%iz_cloud_base, &
             var_name="z_cloud_base", &
      ...
      case ('z_inversion')
        ...
        call stat_assign( var_index=stats_metadata%iz_inversion, &
             var_name="z_inversion", &
      ...
      case ('precip_rate_sfc')          ! Brian
        ...
        call stat_assign( var_index=stats_metadata%iprecip_rate_sfc, &
             var_name="precip_rate_sfc", &
      ...
      case ('rain_flux_sfc')         ! Brian
        ...
        call stat_assign( var_index=stats_metadata%irain_flux_sfc, &
             var_name="rain_flux_sfc", &
      ...
      case ('rrm_sfc')       ! Brian
        ...
        call stat_assign( var_index=stats_metadata%irrm_sfc, &
             var_name="rrm_sfc", &
      ...
      case ( 'morr_snow_rate' )
        ...
        call stat_assign( var_index=stats_metadata%imorr_snow_rate, &
             var_name="morr_snow_rate", &
      ...
      case ('wpthlp_sfc')
        ...
        call stat_assign( var_index=stats_metadata%iwpthlp_sfc, &
             var_name="wpthlp_sfc", &
      ...
      case ('wprtp_sfc')
        ...
        call stat_assign( var_index=stats_metadata%iwprtp_sfc, &
             var_name="wprtp_sfc", &
      ...
      case ('upwp_sfc')
        ...
        call stat_assign( var_index=stats_metadata%iupwp_sfc, &
             var_name="upwp_sfc", &
      ...
      case ('vpwp_sfc')
        ...
        call stat_assign( var_index=stats_metadata%ivpwp_sfc, &
             var_name="vpwp_sfc", &
      ...
      case ('thlm_vert_avg')
        ...
        call stat_assign( var_index=stats_metadata%ithlm_vert_avg, &
             var_name="thlm_vert_avg", &
      ...
      case ('rtm_vert_avg')
        ...
        call stat_assign( var_index=stats_metadata%irtm_vert_avg, &
             var_name="rtm_vert_avg", &
      ...
      case ('um_vert_avg')
        ...
        call stat_assign( var_index=stats_metadata%ium_vert_avg, &
             var_name="um_vert_avg", &
      ...
      case ('vm_vert_avg')
        ...
        call stat_assign( var_index=stats_metadata%ivm_vert_avg, &
             var_name="vm_vert_avg", &
      ...
      case ('wp2_vert_avg')
        ...
        call stat_assign( var_index=stats_metadata%iwp2_vert_avg, &
             var_name="wp2_vert_avg", &
      ...
      case ('up2_vert_avg')
        ...
        call stat_assign( var_index=stats_metadata%iup2_vert_avg, &
             var_name="up2_vert_avg", &
      ...
      case ('vp2_vert_avg')
        ...
        call stat_assign( var_index=stats_metadata%ivp2_vert_avg, &
             var_name="vp2_vert_avg", &
      ...
      case ('rtp2_vert_avg')
        ...
        call stat_assign( var_index=stats_metadata%irtp2_vert_avg, &
             var_name="rtp2_vert_avg", &
      ...
      case ('thlp2_vert_avg')
        ...
        call stat_assign( var_index=stats_metadata%ithlp2_vert_avg, &
             var_name="thlp2_vert_avg", &
      ...
      case ('T_sfc')
        ...
        call stat_assign( var_index=stats_metadata%iT_sfc, &
             var_name="T_sfc", &
      ...
      case ('wp23_matrix_condt_num')
        ...
        call stat_assign( var_index=stats_metadata%iwp23_matrix_condt_num, &
             var_name="wp23_matrix_condt_num", &
      ...
      case ('thlm_matrix_condt_num')
        ...
        call stat_assign( var_index=stats_metadata%ithlm_matrix_condt_num, &
             var_name="thlm_matrix_condt_num", &
      ...
      case ('rtm_matrix_condt_num')
        ...
        call stat_assign( var_index=stats_metadata%irtm_matrix_condt_num, &
             var_name="rtm_matrix_condt_num", &
      ...
      case ('thlp2_matrix_condt_num')
        ...
        call stat_assign( var_index=stats_metadata%ithlp2_matrix_condt_num, &
             var_name="thlp2_matrix_condt_num", &
      ...
      case ('rtp2_matrix_condt_num')
        ...
        call stat_assign( var_index=stats_metadata%irtp2_matrix_condt_num, &
             var_name="rtp2_matrix_condt_num", &
      ...
      case ('windm_matrix_condt_num')
        ...
        call stat_assign( var_index=stats_metadata%iwindm_matrix_condt_num, &
             var_name="windm_matrix_condt_num", &
      ...
      case ('rtm_spur_src')
        ...
        call stat_assign( var_index=stats_metadata%irtm_spur_src, &
             var_name="rtm_spur_src", &
      ...
      case ('thlm_spur_src')
        ...
        call stat_assign( var_index=stats_metadata%ithlm_spur_src, &
             var_name="thlm_spur_src", &
      ...
      case ('rs_sd_morr_int')
        ...
        call stat_assign( var_index=stats_metadata%irsm_sd_morr_int, &
             var_name="rs_sd_morr_int", &
      ...
      case ('tot_vartn_normlzd_rtm')
        ...
        call stat_assign( var_index=stats_metadata%itot_vartn_normlzd_rtm, &
             var_name="tot_vartn_normlzd_rtm", &
      ...
      case ('tot_vartn_normlzd_thlm')
        ...
        call stat_assign( var_index=stats_metadata%itot_vartn_normlzd_thlm, &
             var_name="tot_vartn_normlzd_thlm", &
      ...
      case ('tot_vartn_normlzd_wprtp')
        ...
        call stat_assign( var_index=stats_metadata%itot_vartn_normlzd_wprtp, &
             var_name="tot_vartn_normlzd_wprtp", &
