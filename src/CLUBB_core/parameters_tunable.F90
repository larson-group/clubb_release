...
!$omp   C13, C14, C_wp2_pr_dfsn, C_wp3_pr_tp, C_wp3_pr_turb, C_wp3_pr_dfsn, C_wp2_splat)
...
!$omp   clubb_Cx_max, clubb_Richardson_num_min, clubb_Richardson_num_max)
  ...
  subroutine setup_parameters & 
    ...
    call unpack_parameters & 
             ( params, & ! intent(in)
               C1, C1b, C1c, C2, C2b, C2c, C2rt, C2thl, C2rtthl, & ! intent(out)
  ...
  subroutine read_parameters( iunit, filename, &
    ...
    call pack_parameters &
             ( C1, C1b, C1c, C2, C2b, C2c, C2rt, C2thl, C2rtthl, & ! intent(in)
