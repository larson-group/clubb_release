    ...
    do i = 1, sfc%nn
      ...
      case ('cc')
        ...
        call stat_assign( var_index=icc, var_name="cc", var_description="Cloud cover [count]", &
             var_units="count", l_silhs=.false., grid_kind=sfc )
        k = k + 1
      ...
      case ('rtm_vert_avg')
        ...
        call stat_assign( var_index=irtm_vert_avg, var_name="rtm_vert_avg", &
             ...
             var_units="kg/kg", l_silhs=.false., grid_kind=sfc )
        k = k + 1
      ...
      case ('wp2_vert_avg')
        ...
        call stat_assign( var_index=iwp2_vert_avg, var_name="wp2_vert_avg", &
             ...
             var_units="m^2/s^2", l_silhs=.false., grid_kind=sfc )
        k = k + 1
      ...
      case ('rtp2_vert_avg')
        ...
        call stat_assign( var_index=irtp2_vert_avg, var_name="rtp2_vert_avg", &
             ...
             var_units="kg^2/kg^2", l_silhs=.false., grid_kind=sfc )
        k = k + 1
      ...
      case ('thlp2_vert_avg')
        ...
        call stat_assign( var_index=ithlp2_vert_avg, var_name="thlp2_vert_avg", &
             ...
             var_units="K^2", l_silhs=.false., grid_kind=sfc )
        k = k + 1
