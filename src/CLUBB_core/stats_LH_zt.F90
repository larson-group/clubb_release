    ...
    do i = 1, LH_zt%nn
      ...
      case ( 'AKm' )           ! Vince Larson 22 May 2005
        ...
        call stat_assign( iAKm, "AKm", & 
             "Analytic Kessler ac [kg/kg]", "kg/kg", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_AKm' )       ! Vince Larson 22 May 2005
        ...
        call stat_assign( iLH_AKm, "LH_AKm", & 
             "LH Kessler estimate  [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'AKstd' )
        ...
        call stat_assign( iAKstd, "AKstd", & 
             "Exact standard deviation of gba Kessler [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'AKstd_cld' )
        ...
        call stat_assign( iAKstd_cld, "AKstd_cld", & 
             "Exact w/in cloud std of gba Kessler [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'AKm_rcm' )
        ...
        call stat_assign( iAKm_rcm, "AKm_rcm", & 
             "Exact local gba auto based on rcm [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'AKm_rcc' )
        ...
        call stat_assign( iAKm_rcc, "AKm_rcc", & 
             "Exact local gba based on w/in cloud rc [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_rvm_mc' )
        ...
        call stat_assign( iLH_rvm_mc, "LH_rvm_mc", & 
             "Latin hypercube estimate of rvm_mc [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_thlm_mc' )
        ...
        call stat_assign( iLH_thlm_mc, "LH_thlm_mc", & 
             "Latin hypercube estimate of thlm_mc [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_rcm_mc' )
        ...
        call stat_assign( iLH_rcm_mc, "LH_rcm_mc", & 
             "Latin hypercube estimate of rcm_mc [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_Ncm_mc' )
        ...
        call stat_assign( iLH_Ncm_mc, "LH_Ncm_mc", & 
             "Latin hypercube estimate of Ncm_mc [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_rrainm_mc' )
        ...
        call stat_assign( iLH_rrainm_mc, "LH_rrainm_mc", & 
             "Latin hypercube estimate of rrainm_mc [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_Nrm_mc' )
        ...
        call stat_assign( iLH_Nrm_mc, "LH_Nrm_mc", & 
             "Latin hypercube estimate of Nrm_mc [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case('LH_rsnowm_mc')
        ...
        call stat_assign( iLH_rsnowm_mc, "LH_rsnowm_mc", & 
             "Latin hypercube estimate of rsnowm_mc [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_Nsnowm_mc' )
        ...
        call stat_assign( iLH_Nsnowm_mc, "LH_Nsnowm_mc", & 
             "Latin hypercube estimate of Nsnowm_mc [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_rgraupelm_mc' )
        ...
        call stat_assign( iLH_rgraupelm_mc, "LH_rgraupelm_mc", & 
             "Latin hypercube estimate of rgraupelm_mc [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_Ngraupelm_mc' )
        ...
        call stat_assign( iLH_Ngraupelm_mc, "LH_Ngraupelm_mc", & 
             "Latin hypercube estimate of Ngraupelm_mc [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_ricem_mc' )
        ...
        call stat_assign( iLH_ricem_mc, "LH_ricem_mc", & 
             "Latin hypercube estimate of ricem_mc [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_Nim_mc' )
        ...
        call stat_assign( iLH_Nim_mc, "LH_Nim_mc", & 
             "Latin hypercube estimate of Nim_mc [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_Vrr' )
        ...
        call stat_assign( iLH_Vrr, "LH_Vrr", & 
             "Latin hypercube estimate of rrainm sedimentation velocity [m/s]", &
                "m/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_VNr' )
        ...
        call stat_assign( iLH_VNr, "LH_VNr", & 
             "Latin hypercube estimate of Nrm sedimentation velocity [m/s]", &
                "m/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_rcm_avg' )
        ...
        call stat_assign( iLH_rcm_avg, "LH_rcm_avg", & 
             "Latin hypercube average estimate of rcm [kg/kg]", "kg/kg", l_yes_silhs, LH_zt )
      ...
      case ( 'LH_rrainm' )
        ...
        call stat_assign( iLH_rrainm, "LH_rrainm", & 
             "Latin hypercube estimate of rrainm [kg/kg]", "kg/kg", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_Nrm' )
        ...
        call stat_assign( iLH_Nrm, "LH_Nrm", & 
             "Latin hypercube estimate of Nrm [count/kg]", "count/kg", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_ricem' )
        ...
        call stat_assign( iLH_ricem, "LH_ricem", & 
             "Latin hypercube estimate of ricem [kg/kg]", "kg/kg", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_Nim' )
        ...
        call stat_assign( iLH_Nim, "LH_Nim", & 
             "Latin hypercube estimate of Nim [count/kg]", "count/kg", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_rsnowm' )
        ...
        call stat_assign( iLH_rsnowm, "LH_rsnowm", & 
             "Latin hypercube estimate of rsnowm [kg/kg]", "kg/kg", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_Nsnowm' )
        ...
        call stat_assign( iLH_Nsnowm, "LH_Nsnowm", & 
             "Latin hypercube estimate of Nsnowm [count/kg]", "count/kg", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_rgraupelm' )
        ...
        call stat_assign( iLH_rgraupelm, "LH_rgraupelm", & 
             "Latin hypercube estimate of rgraupelm [kg/kg]", "kg/kg", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_Ngraupelm' )
        ...
        call stat_assign( iLH_Ngraupelm, "LH_Ngraupelm", & 
             "Latin hypercube estimate of Ngraupelm [kg/kg]", "kg/kg", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_thlm' )
        ...
        call stat_assign( iLH_thlm, "LH_thlm", & 
             "Latin hypercube estimate of thlm [K]", "K", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_rcm' )
        ...
        call stat_assign( iLH_rcm, "LH_rcm", & 
             "Latin hypercube estimate of rcm [kg/kg]", "kg/kg", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_Ncm' )
        ...
        call stat_assign( iLH_Ncm, "LH_Ncm", & 
             "Latin hypercube estimate of Ncm [count/kg]", "count/kg", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_rvm' )
        ...
        call stat_assign( iLH_rvm, "LH_rvm", & 
             "Latin hypercube estimate of rvm [kg/kg]", "kg/kg", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_wm' )
        ...
        call stat_assign( iLH_wm, "LH_wm", & 
             "Latin hypercube estimate of vertical velocity [m/s]", "m/s", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_cloud_frac' )
        ...
        call stat_assign( iLH_cloud_frac, "LH_cloud_frac", & 
             "Latin hypercube estimate of cloud fraction [count]", "count", l_yes_silhs, LH_zt )
        k = k + 1

      case ( 'LH_s_mellor' )
        iLH_s_mellor = k
        call stat_assign( iLH_s_mellor, "LH_s_mellor", &
             "Latin hypercube estimate of Mellor's s (extended liq) [kg/kg]", "kg/kg", &
                l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_t_mellor' )
        ...
        call stat_assign( iLH_t_mellor, "LH_t_mellor", &
             "Latin hypercube estimate of Mellor's t [kg/kg]", "kg/kg", l_yes_silhs, LH_zt )
        k = k + 1

      case ( 'LH_sp2' )
        iLH_sp2 = k
        call stat_assign( iLH_sp2, "LH_sp2", &
             "Latin hypercube estimate of variance of s [kg/kg]", "kg/kg", l_yes_silhs, LH_zt )
        k = k + 1

      case ( 'LH_wp2_zt' )
        iLH_wp2_zt = k
        call stat_assign( iLH_wp2_zt, "LH_wp2_zt", & 
             "Variance of the latin hypercube estimate of w [m^2/s^2]", &
                "m^2/s^2", l_yes_silhs, LH_zt )
        k = k + 1

      case ( 'LH_Ncp2_zt' )
        iLH_Ncp2_zt = k
        call stat_assign( iLH_Ncp2_zt, "LH_Ncp2_zt", & 
          "Variance of the latin hypercube estimate of Nc [count^2/kg^2]", &
             "count^2/kg^2", l_yes_silhs, LH_zt )
        k = k + 1

      case ( 'LH_Nrp2_zt' )
        iLH_Nrp2_zt = k
        call stat_assign( iLH_Nrp2_zt, "LH_Nrp2_zt", & 
          "Variance of the latin hypercube estimate of Nr [count^2/kg^2]", &
             "count^2/kg^2", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_rcp2_zt' )
        ...
        call stat_assign( iLH_rcp2_zt, "LH_rcp2_zt", & 
             "Variance of the latin hypercube estimate of rc [kg^2/kg^2]", &
                "kg^2/kg^2", l_yes_silhs, LH_zt )
        k = k + 1

      case ( 'LH_rtp2_zt' )
        iLH_rtp2_zt = k
        call stat_assign( iLH_rtp2_zt, "LH_rtp2_zt", & 
             "Variance of the latin hypercube estimate of rt [kg^2/kg^2]", &
                "kg^2/kg^2", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_thlp2_zt' )
        ...
        call stat_assign( iLH_thlp2_zt, "LH_thlp2_zt", & 
             "Variance of the latin hypercube estimate of thl [K^2]", &
                "K^2", l_yes_silhs, LH_zt )
        k = k + 1

      case ( 'LH_rrainp2_zt' )
        iLH_rrainp2_zt = k
        call stat_assign( iLH_rrainp2_zt, "LH_rrainp2_zt", & 
             "Variance of the latin hypercube estimate of rrain [kg^2/kg^2]", &
                "kg^2/kg^2", l_yes_silhs, LH_zt )
        k = k + 1
      ...
      case ( 'LH_rrainm_auto' )
        ...
        call stat_assign( iLH_rrainm_auto, "LH_rrainm_auto", & 
             "Latin hypercube estimate of autoconversion [kg/kg/s]", &
      ...
      case ( 'LH_rrainm_accr' )
        ...
        call stat_assign( iLH_rrainm_accr, "LH_rrainm_accr", & 
             "Latin hypercube estimate of accretion [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1

      case ( 'LH_rrainm_evap' )
        iLH_rrainm_evap = k
        call stat_assign( iLH_rrainm_evap, "LH_rrainm_evap", &
             "Latin hypercube estimate of evaporation [kg/kg/s]", "kg/kg/s", l_yes_silhs, LH_zt )
        k = k + 1

      case ( 'LH_Nrm_auto' )
        iLH_Nrm_auto = k
        call stat_assign( iLH_Nrm_auto, "LH_Nrm_auto", &
             "Latin hypercube estimate of Nrm autoconversion [num/kg/s]", &
                "num/kg/s", l_yes_silhs, LH_zt )
        k = k + 1

      case ( 'LH_Nrm_cond' )
        iLH_Nrm_cond = k
        call stat_assign( iLH_Nrm_cond, "LH_Nrm_cond", &
             "Latin hypercube estimate of Nrm evaporation [num/kg/s]", &
                "num/kg/s", l_yes_silhs, LH_zt )
        k = k + 1
