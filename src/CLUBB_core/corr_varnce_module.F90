...
!===============================================================================
  subroutine setup_corr_varnce_array_api( pdf_dim, hm_metadata, &
                                          l_fix_w_chi_eta_correlations, &
                                          corr_array_n_cloud, corr_array_n_below, &
                                          corr_array_n_cloud_default, &
                                          corr_array_n_below_default )
...
!-------------------------------------------------------------------------------
    ...
    real( kind = core_rknd ), intent(in), optional, dimension(pdf_dim,pdf_dim) :: &
      corr_array_n_cloud_default, &
      corr_array_n_below_default
    ...
    if ( present( corr_array_n_cloud_default ) .and. &
         present( corr_array_n_below_default ) ) then
      corr_array_n_cloud = corr_array_n_cloud_default
      corr_array_n_below = corr_array_n_below_default
    else
