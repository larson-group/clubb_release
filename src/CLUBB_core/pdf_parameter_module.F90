...
!-------------------------------------------------------------------------------
  ...
  type pdf_parameter
    real( kind = core_rknd ) :: &
      ...
      crt1,        & ! Coef. on r_t in chi/eta eqns. (1st PDF comp.)             [-]
      crt2,        & ! Coef. on r_t in chi/eta eqns. (2nd PDF comp.)             [-]
      cthl1,       & ! Coef. on th_l in chi/eta eqns. (1st PDF comp.)    [(kg/kg)/K]
      cthl2,       & ! Coef. on th_l in chi/eta eqns. (2nd PDF comp.)    [(kg/kg)/K]
