...
!-----------------------------------------------------------------------
    ...
    clubb_config_flags%l_linear_Kh_dp_term = l_linear_Kh_dp_term
...
!-----------------------------------------------------------------------
    ...
    write(iunit,*) "l_linear_Kh_dp_term = ", clubb_config_flags%l_linear_Kh_dp_term
