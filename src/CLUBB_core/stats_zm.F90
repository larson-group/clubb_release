    ...
    do i=1,zm%nn
      ...
      case ('wp2_bt')
        ...
        call stat_assign(iwp2_bt,"wp2_bt", & 
             "wp2 time tendency [m^2/s^3]","m^2/s^3",zm)
        k = k + 1
      ...
      case ('wp2_ma')
        ...
        call stat_assign(iwp2_ma,"wp2_ma", & 
             "wp2 vertical mean advection [m^2/s^3]","m^2/s^3",zm)
        k = k + 1
      ...
      case ('wp2_ta')
        ...
        call stat_assign(iwp2_ta,"wp2_ta", & 
             "wp2 turbulent advection [m^2/s^3]","m^2/s^3",zm)
        k = k + 1
      ...
      case ('wp2_ac')
        ...
        call stat_assign(iwp2_ac,"wp2_ac", & 
             "wp2 accumulation term [m^2/s^3]","m^2/s^3",zm)
        k = k + 1
      ...
      case ('wp2_bp')
        ...
        call stat_assign(iwp2_bp,"wp2_bp", & 
             "wp2 buoyancy production [m^2/s^3]","m^2/s^3",zm)
        k = k + 1
      ...
      case ('wp2_pr1')
        ...
        call stat_assign(iwp2_pr1,"wp2_pr1", & 
             "wp2 pressure term 1 [m^2/s^3]","m^2/s^3",zm)
        k = k + 1

      case ('wp2_pr2')
        iwp2_pr2 = k
        call stat_assign(iwp2_pr2,"wp2_pr2", & 
             "wp2 pressure term 2 [m^2/s^3]","m^2/s^3",zm)
        k = k + 1

      case ('wp2_pr3')
        iwp2_pr3 = k
        call stat_assign(iwp2_pr3,"wp2_pr3", & 
             "wp2 pressure term 3 [m^2/s^3]","m^2/s^3",zm)
      ...
      case ('wp2_dp1')
        ...
        call stat_assign(iwp2_dp1,"wp2_dp1", & 
             "wp2 dissipation term 1 [m^2/s^3]","m^2/s^3",zm)
        k = k + 1

      case ('wp2_dp2')
        iwp2_dp2 = k
        call stat_assign(iwp2_dp2,"wp2_dp2", & 
             "wp2 dissipation term 2 [m^2/s^3]","m^2/s^3",zm)
      ...
      case ('wp2_4hd')
        ...
        call stat_assign(iwp2_4hd,"wp2_4hd", & 
             "wp2 4th-order hyper-diffusion [m^2/s^3]","m^2/s^3",zm)
      ...
      case ('wp2_cl')
        ...
        call stat_assign(iwp2_cl,"wp2_cl", & 
             "wp2 clipping term [m^2/s^3]","m^2/s^3",zm)
      ...
      case ('wp2_pd')
        ...
        call stat_assign(iwp2_pd,"wp2_pd", & 
             "wp2 positive definite adjustment [m^2/s^3]","m2/s3",zm)
      ...
      case ('wprtp_bt')
        ...
        call stat_assign(iwprtp_bt,"wprtp_bt", & 
             "wprtp time tendency [(m kg)/(s^2 kg)]","(m kg)/(s^2 kg)",zm)
        k = k + 1
      ...
      case ('wprtp_ma')
        ...
        call stat_assign(iwprtp_ma,"wprtp_ma", & 
             "wprtp mean advection [(m kg)/(s^2 kg)]","(m kg)/(s^2 kg)",zm)
        k = k + 1
      ...
      case ('wprtp_ta')
        ...
        call stat_assign(iwprtp_ta,"wprtp_ta", & 
             "wprtp turbulent advection [(m kg)/(s^2 kg)]","(m kg)/(s^2 kg)",zm)
        k = k + 1
      ...
      case ('wprtp_tp')
        ...
        call stat_assign(iwprtp_tp,"wprtp_tp", & 
             "wprtp turbulent production [(m kg)/(s^2 kg)]","(m kg)/(s^2 kg)",zm)
        k = k + 1
      ...
      case ('wprtp_ac')
        ...
        call stat_assign(iwprtp_ac,"wprtp_ac", & 
             "wprtp accumulation term [(m kg)/(s^2 kg)]","(m kg)/(s^2 kg)",zm)
        k = k + 1
      ...
      case ('wprtp_bp')
        ...
        call stat_assign(iwprtp_bp,"wprtp_bp", & 
             "wprtp buoyancy production [(m kg)/(s^2 kg)]","(m kg)/(s^2 kg)",zm)
        k = k + 1
      ...
      case ('wprtp_pr1')
        ...
        call stat_assign(iwprtp_pr1,"wprtp_pr1", & 
             "wprtp pressure term 1 [(m kg)/(s^2 kg)]","(m kg)/(s^2 kg)",zm)
        k = k + 1
      ...
      case ('wprtp_pr3')
        ...
        call stat_assign(iwprtp_pr3,"wprtp_pr3", & 
             "wprtp pressure term 3 [(m kg)/(s^2 kg)]","(m kg)/(s^2 kg)",zm)
        k = k + 1
      ...
      case ('wprtp_dp1')
        ...
        call stat_assign(iwprtp_dp1,"wprtp_dp1", & 
             "wprtp dissipation term 1 [(m kg)/(s^2 kg)]","(m kg)/(s^2 kg)",zm)
        k = k + 1
      ...
      case ('wprtp_mfl')
        ...
        call stat_assign(iwprtp_mfl,"wprtp_mfl", & 
             "wprtp monotonic flux limiter [(m kg)/(s^2 kg)]","(m kg)/(s^2 kg)",zm)
        k = k + 1
      ...
      case ('wprtp_cl')
        ...
        call stat_assign(iwprtp_cl,"wprtp_cl", & 
             "wprtp clipping term [(m kg)/(s^2 kg)]","(m kg)/(s^2 kg)",zm)
        k = k + 1
      ...
      case ('wprtp_sicl')
        ...
        call stat_assign(iwprtp_sicl,"wprtp_sicl", & 
             "wprtp semi-implicit clipping term [(m kg)/(s^2 kg)]","(m kg)/(s^2 kg)",zm)
        k = k + 1
      ...
      case ('wprtp_pd')
        ...
        call stat_assign(iwprtp_pd,"wprtp_pd", & 
             "wprtp flux corrected trans. term [(m kg)/(s^2 kg)]","(m kg)/(s^2 kg)",zm)
        k = k + 1
      ...
      case ('wpthlp_ma')
        ...
        call stat_assign(iwpthlp_ma,"wpthlp_ma", & 
             "wpthlp mean advection [(m K)/s^2]","(m K)/s^2",zm)
      ...
      case ('wpthlp_ta')
        ...
        call stat_assign(iwpthlp_ta,"wpthlp_ta", & 
             "wpthlp turbulent advection [(m K)/s^2]","(m K)/s^2",zm)
      ...
      case ('wpthlp_tp')
        ...
        call stat_assign(iwpthlp_tp,"wpthlp_tp", & 
             "wpthlp turbulent production [(m K)/s^2]","(m K)/s^2",zm)
      ...
      case ('wpthlp_ac')
        ...
        call stat_assign(iwpthlp_ac,"wpthlp_ac", & 
             "wpthlp accumulation term [(m K)/s^2]","(m K)/s^2",zm)
      ...
      case ('wpthlp_bp')
        ...
        call stat_assign(iwpthlp_bp,"wpthlp_bp", & 
             "wpthlp buoyancy production [(m K)/s^2]","(m K)/s^2",zm)
        k = k + 1
      ...
      case ('wpthlp_pr1')
        ...
        call stat_assign(iwpthlp_pr1,"wpthlp_pr1", & 
             "wpthlp pressure term 1 [(m K)/s^2]","(m K)/s^2",zm)
        k = k + 1
      ...
      case ('wpthlp_pr2')
        ...
        call stat_assign(iwpthlp_pr2,"wpthlp_pr2", & 
             "wpthlp pressure term 2 [(m K)/s^2]","(m K)/s^2",zm)
        k = k + 1

      case ('wpthlp_pr3')
        iwpthlp_pr3 = k
        call stat_assign(iwpthlp_pr3,"wpthlp_pr3", & 
             "wpthlp pressure term 3 [(m K)/s^2]","(m K)/s^2",zm)
        k = k + 1

      case ('wpthlp_dp1')
        iwpthlp_dp1 = k
        call stat_assign(iwpthlp_dp1,"wpthlp_dp1", & 
             "wpthlp dissipation term 1 [(m K)/s^2]","(m K)/s^2",zm)
        k = k + 1

      case ('wpthlp_mfl')
        iwpthlp_mfl = k
        call stat_assign(iwpthlp_mfl,"wpthlp_mfl", & 
             "wpthlp monotonic flux limiter [(m K)/s^2]","(m K)/s^2",zm)
        k = k + 1

      case ('wpthlp_cl')
        iwpthlp_cl = k
        call stat_assign(iwpthlp_cl,"wpthlp_cl", & 
             "wpthlp clipping term [(m K)/s^2]","(m K)/s^2",zm)
        k = k + 1

      case ('wpthlp_sicl')
        iwpthlp_sicl = k
        call stat_assign(iwpthlp_sicl,"wpthlp_sicl", & 
             "wpthlp semi-implicit clipping term [(m K)/s^2]","(m K)/s^2",zm)
        k = k + 1
      ...
      case ('thlp2_bt')
        ...
        call stat_assign(ithlp2_bt,"thlp2_bt", & 
             "thlp2 time tendency [(K^2)/s]","(K^2)/s",zm)
        k = k + 1
      case ('thlp2_ma')
        ithlp2_ma = k
        call stat_assign(ithlp2_ma,"thlp2_ma", & 
             "thlp2 mean advection [(K^2)/s]","(K^2)/s",zm)
        k = k + 1
      case ('thlp2_ta')
        ithlp2_ta = k
        call stat_assign(ithlp2_ta,"thlp2_ta", & 
             "thlp2 turbulent advection [(K^2)/s]","(K^2)/s",zm)
        k = k + 1
      case ('thlp2_tp')
        ithlp2_tp = k
        call stat_assign(ithlp2_tp,"thlp2_tp", & 
             "thlp2 turbulent production [(K^2)/s]","(K^2)/s",zm)
        k = k + 1
      case ('thlp2_dp1')
        ithlp2_dp1 = k
        call stat_assign(ithlp2_dp1,"thlp2_dp1", & 
             "thlp2 dissipation term 1 [(K^2)/s]","(K^2)/s",zm)
        k = k + 1
      case ('thlp2_dp2')
        ithlp2_dp2 = k
        call stat_assign(ithlp2_dp2,"thlp2_dp2", & 
             "thlp2 dissipation term 2 [(K^2)/s]","(K^2)/s",zm)
        k = k + 1
      case ('thlp2_cl')
        ithlp2_cl = k
        call stat_assign(ithlp2_cl,"thlp2_cl", & 
             "thlp2 clipping term [(K^2)/s]","(K^2)/s",zm)
        k = k + 1

      case ('thlp2_pd')
        ithlp2_pd = k
        call stat_assign( ithlp2_pd, "thlp2_pd", & 
             "thlp2 positive definite adjustment [(K^2)/s]", "m^2/s^2", zm )
        k = k + 1

      case ('rtpthlp_bt')
        irtpthlp_bt = k
        call stat_assign(irtpthlp_bt,"rtpthlp_bt", & 
             "rtpthlp time tendency [(kg K)/(kg s)]","(kg K)/(kg s)",zm)
        k = k + 1
      case ('rtpthlp_ma')
        irtpthlp_ma = k
        call stat_assign(irtpthlp_ma,"rtpthlp_ma", & 
             "rtpthlp mean advection [(kg K)/(kg s)]","(kg K)/(kg s)",zm)
        k = k + 1
      case ('rtpthlp_ta')
        irtpthlp_ta = k
        call stat_assign(irtpthlp_ta,"rtpthlp_ta", & 
             "rtpthlp turbulent advection [](kg K)/(kg s)","(kg K)/(kg s)",zm)
        k = k + 1
      case ('rtpthlp_tp1')
        irtpthlp_tp1 = k
        call stat_assign(irtpthlp_tp1,"rtpthlp_tp1", & 
             "rtpthlp turbulent production 1 [(kg K)/(kg s)]","(kg K)/(kg s)",zm)
        k = k + 1
      case ('rtpthlp_tp2')
        irtpthlp_tp2 = k
        call stat_assign(irtpthlp_tp2,"rtpthlp_tp2", & 
             "rtpthlp turbulent production 2 [(kg K)/(kg s)]","(kg K)/(kg s)",zm)
        k = k + 1
      case ('rtpthlp_dp1')
        irtpthlp_dp1 = k
        call stat_assign(irtpthlp_dp1,"rtpthlp_dp1", & 
             "rtpthlp dissipation term 1 [(kg K)/(kg s)]","(kg K)/(kg s)",zm)
        k = k + 1
      case ('rtpthlp_dp2')
        irtpthlp_dp2 = k
        call stat_assign(irtpthlp_dp2,"rtpthlp_dp2", & 
             "rtpthlp dissipation term 2 [(kg K)/(kg s)]","(kg K)/(kg s)",zm)
        k = k + 1
      case ('rtpthlp_cl')
        irtpthlp_cl = k
        call stat_assign(irtpthlp_cl,"rtpthlp_cl", & 
             "rtpthlp clipping term [(kg K)/(kg s)]","(kg K)/(kg s)",zm)
        k = k + 1
