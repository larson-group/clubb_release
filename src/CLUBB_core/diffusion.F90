...
module diffusion
  ...
  subroutine diffusion_zt_lhs( nz, ngrdcol, gr, K_zm, K_zt, nu,  & ! In
    ...
    !$acc  data create( lhs_upwind, drhoKdz_zt, K_zm_nu, rho_K_zm_nu, ddzm_rho_K_zm_nu ) async(1) 
...
!                        ( cloud_frac_zmm1 / cloud_frac_ztm1 ) * invrs_dzmm1
  ...
  subroutine diffusion_zm_lhs( nz, ngrdcol, gr, K_zt, K_zm, nu,   & ! In
    ...
    !$acc  data create( lhs_upwind, drhoKdz_zm, rho_K_zt_nu, ddzt_rho_K_zt_nu ) async(1) 
