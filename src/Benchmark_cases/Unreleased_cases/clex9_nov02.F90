...
! Description:
!   Compute subsidence and large-scale tendencies.
...
!----------------------------------------------------------------------
  ...
  use constants_clubb, only: Lv, Cp, zero_threshold, fstderr ! Variable(s)
...
!-----------------------------------------------------------------------
  ...
  !----------------------
  wmax =  0.007
    z_inversion = 1600.0 + gr%zm(1)
  daz_inversion = 1000.0
  dbz_inversion = 1000.0
   dbc =  300.0
   dac =  200.0
