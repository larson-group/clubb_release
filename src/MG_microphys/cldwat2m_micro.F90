...
! variabels to check for RH after rain evap
    ...
    real( kind = core_rknd ) :: &
      ...
      mu_eta_1,        & ! Mean of eta(t) (1st PDF component)                   [kg/kg]
      mu_eta_2,        & ! Mean of eta(t) (2nd PDF component)                   [kg/kg]
      ...
      sigma_eta_1,     & ! Standard deviation of eta(t) (1st PDF component)     [kg/kg]
      sigma_eta_2,     & ! Standard deviation of eta(t) (2nd PDF component)     [kg/kg]
