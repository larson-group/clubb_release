!-----------------------------------------------------------------------
!$Id: interpolation.F90,v 1.1 2008-07-22 16:04:14 faschinj Exp $
...
!------------------------------------------------------------------------
        elemental real function linint( zmid, ztop, zbot, vtop, vbot )
...
!-----------------------------------------------------------------------
        ...
        if(topbound == -1 .or. bottombound == -1) then
           call clubb_debug(1,  & 
               "Sanity check failed! xlist is not properly sorted" )
           call clubb_debug(1, & 
               "in linear_interpolation.")
        endif
