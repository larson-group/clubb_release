%
% $Id: compare_plots_cases_driver.m,v 1.3 2007-05-01 23:21:23 dschanen Exp $
%
...
%                                                         )
% Description:
% Driver for the comparison of GrADS data output.
%
% Author:
% Brian  M. Griffin
...
for i = 1:1:16
   if ( i == 1 )
      if ( arm_success == 1 )
         compare_plots_cases( 'arm', 481, 540, 3500.0, ...
   ...
   elseif ( i == 2 )
      if ( atex_success == 1 )
         compare_plots_cases( 'atex', 421, 480, 2500.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              1, 'coamps', 1, 1, 1, 1 )
      else
   ...
   elseif ( i == 3 )
      if ( bomex_success == 1 )
         compare_plots_cases( 'bomex', 181, 360, 2500.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              1, 'coamps', 1, 1, 1, 1 )
      else
   ...
   elseif ( i == 4 )
      if ( cobra_success == 1 )
         compare_plots_cases( 'cobra', 241, 300, 3500.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              0, '', 0, 0, 1, 1 )
      else
   ...
   elseif ( i == 5 )
      if ( rf01_success == 1 )
         compare_plots_cases( 'dycoms2_rf01', 181, 240, 1200.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              1, 'coamps', 1, 1, 1, 1 )
      else
   ...
   elseif ( i == 6 )
      if ( rf02_do_success == 1 )
         compare_plots_cases( 'dycoms2_rf02_do', 301, 360, 1200.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              1, 'coamps', 1, 1, 1, 1 )
      else
   ...
   elseif ( i == 7 )
      if ( rf02_ds_success == 1 )
         compare_plots_cases( 'dycoms2_rf02_ds', 301, 360, 1200.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              1, 'coamps', 1, 1, 1, 1 )
      else
   ...
   elseif ( i == 8 )
      if ( rf02_nd_success == 1 )
         compare_plots_cases( 'dycoms2_rf02_nd', 301, 360, 1200.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              1, 'coamps', 1, 1, 1, 1 )
      else
   ...
   elseif ( i == 9 )
      if ( rf02_so_success == 1 )
         compare_plots_cases( 'dycoms2_rf02_so', 301, 360, 1200.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              0, '', 1, 1, 1, 1 )
      else
   ...
   elseif ( i == 10 )
      if ( fire_success == 1 )
         compare_plots_cases( 'fire', 61, 120, 1000.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              1, 'coamps', 1, 1, 1, 1 )
      else
   ...
   elseif ( i == 11 )
      if ( gabls_success == 1 )
         compare_plots_cases( 'gabls2', 2101, 2160, 2500.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              1, 'coamps', 0, 0, 1, 1 )
      else
   ...
   elseif ( i == 12 )
      if ( jun25_success == 1 )
         compare_plots_cases( 'jun25_altocu', 61, 120, 7308.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              1, 'coamps', 0, 0, 1, 1 )
      else
   ...
   elseif ( i == 13 )
      if ( mpace_success == 1 )
         compare_plots_cases( 'mpace', 541, 720, 2750.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              0, '', 0, 0, 1, 1 )
      else
   ...
   elseif ( i == 14 )
      if ( nov11_success == 1 )
         compare_plots_cases( 'nov11_altocu', 61, 120, 6150.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              1, 'coamps', 1, 1, 1, 1 )
      else
   ...
   elseif ( i == 15 )
      if ( rico_success == 1 )
         compare_plots_cases( 'rico', 1261, 1440, 3500.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              1, 'coamps', 0, 0, 1, 1 )
      else
   ...
   elseif ( i == 16 )
      if ( wangara_success == 1 )
         compare_plots_cases( 'wangara', 181, 240, 1900.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              1, 'rams', 1, 1, 1, 1 )
      else
