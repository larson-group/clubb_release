%
% $Id: compare_plots_cases_driver.m,v 1.2 2007-03-02 20:42:34 dschanen Exp $
%
...
for i = 1:1:16
   ...
   elseif ( i == 12 )
      if ( jun25_success == 1 )
         compare_plots_cases( 'jun25_altocu', 61, 120, 2500.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              1, 'coamps', 0, 0, 1, 1 )
      else
   ...
   elseif ( i == 14 )
      if ( nov11_success == 1 )
         compare_plots_cases( 'nov11_altocu', 61, 120, 2000.0, ...
                              'LES_files', 'Chris_Golaz_best_ever', ...
                              'HOC_20051217', 'HOC_previous', 'HOC_current', ...
                              1, 'coamps', 1, 1, 1, 1 )
      else
