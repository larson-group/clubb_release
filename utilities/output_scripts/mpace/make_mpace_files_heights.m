...
filenumber   = [0;1;2;3;4;5;8;10;11;12;19;20;21;31;36;];
...
multfactor   = [.01; .001; 1; 1000; 1; 1000; 1000; 1; 1; 1; 86400; 86400; 86400; 1; .001;];

formatting   = ['%07.1f';'%07.3f';'%07.2f';'%07.3f';'%06.3f';'%07.4f';'%07.4f';'%06.3f';
...
for v=1:sizevars(1)
    ...
    string = ['fid=fopen(''b2_p',num2str(filenumber(v)),'_UWM'',''w'')'];
    eval(string);
...
for v=1:sizevars(1)
    str = strtrim(variablelist(v,:))
    string = ['fid=fopen(''b2_p',num2str(filenumber(v)),'_UWM.not_submitted'',''w'')'];
    eval(string);
end
...
for v=1:3
    ...
    string = ['fid=fopen(''b2_t',num2str(v),'_UWM'',''w'');'];
    eval(string);
