% $Id$
function PDF_integrate_fnc_NNLL( a_exp, b_exp, x2_opt )
...
fprintf( 'number of partitions: x1: %d; x2: %d; x3: %d; x4: %d\n', ...
         num_partitions_x1, num_partitions_x2, num_partitions_x3, ...
         num_partitions_x4 );

% Partition size for x1, x2, x3, and x4.
...
fprintf( 'partition sizes: x1: %7.5e; x2: %7.5e; x3: %7.5e; x4: %7.5e\n', ...
         ...
         for iter_x4 = 1:1:num_partitions_x4
            ...
            sum = sum ...
                  + delta_x1 * delta_x2 * delta_x3 * delta_x4 ...
                    ...
                    * PDF_comp_quadrivar_NNLL ...
                         ( x1, x2, x3, x4, mu_x1, mu_x2, mu_x3_n, ...
                           mu_x4_n, sigma_x1, sigma_x2, ...
                           sigma_x3_n, sigma_x4_n, rho_x1x2, ...
                           rho_x1x3_n, rho_x1x4_n, rho_x2x3_n, ...
                           rho_x2x4_n, rho_x3x4_n );
