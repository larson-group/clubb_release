% $Id$
function PDF_integrate_fnc_NNLL_const_x1_x2( a_exp, b_exp, x2_opt )
...
%
% In this special case, the x1 and x2 variables are held constant.
...
fprintf( 'number of partitions: x3: %d; x4: %d\n', ...
         num_partitions_x3, num_partitions_x4 );

% Partition size for x3 and x4.
delta_x3 = ( integral_ub_x3 - integral_lb_x3 ) / num_partitions_x3;
delta_x4 = ( integral_ub_x4 - integral_lb_x4 ) / num_partitions_x4;

fprintf( 'partition sizes: x3: %7.5e; x4: %7.5e\n', ...
         delta_x3, delta_x4 );
      ...
      for iter_x4 = 1:1:num_partitions_x4
         ...
         sum = sum ...
               + delta_x3 * delta_x4 ...
                 ...
                 * PDF_comp_bivar_LL ...
                      ( x3, x4, mu_x3_n, mu_x4_n, ...
                        sigma_x3_n, sigma_x4_n, rho_x3x4_n );
