% $Id$
function PDF_integrate_fnc_NNL_const_x1_x2( a_exp, b_exp, x2_opt )
...
fprintf( 'number of partitions: x3: %d\n', num_partitions_x3 );

% Partition size for x3.
delta_x3 = ( integral_ub_x3 - integral_lb_x3 ) / num_partitions_x3;

fprintf( 'partition size: x3: %7.5e\n', delta_x3 );
...
if ( mu_x2 < 0.0 )
   ...
   sigma_sum_2 = ( - x2_alpha_x3_beta_bar )^b_exp * ( mu_x1 - x1_bar )^a_exp;
