% $Id$
function [ P_i ] ...
= PDF_comp_trivar_NLL( x1, x2, x3, mu_x1_i, mu_x2_ni, mu_x3_ni, ...
                       sigma_x1_i, sigma_x2_ni, sigma_x3_ni, ...
                       rho_x1x2_ni, rho_x1x3_ni, rho_x2x3_ni )

% This function calculates probability density given by the Probability
% Density Function (PDF) for a trivariate normal-lognormal-lognormal
...
% A trivariate normal-lognormal-lognormal PDF
P_i ...
= 1.0 / ( (2.0*pi)^(3.0/2.0) ...
          * sigma_x1_i * sigma_x2_ni * sigma_x3_ni * C_1 * x2 * x3 ) ...
  * exp( - ( 1.0 / ( 2.0 * C_1^2 ) ) ...
           * (   C_2 * ( x1 - mu_x1_i )^2 ...
               + C_3 * ( log( x2 ) - mu_x2_ni )^2 ...
               + C_4 * ( log( x3 ) - mu_x3_ni )^2 ...
               + C_5 * ( x1 - mu_x1_i ) * ( log( x2 ) - mu_x2_ni ) ...
