...
def advance_xm_wpxp(
    ...
    result = clubb_f2py.f2py_advance_xm_wpxp(
        ...
        f_arr(wp3), f_arr(kh_zt), f_arr(kh_zm),
        f_arr(stability_correction),
        f_arr(invrs_tau_c6_zm), f_arr(tau_max_zm), f_arr(wp2rtp), f_arr(rtpthvp),
        ...
        np.asarray(wprtp_cl_num, dtype=np.int32), np.asarray(wpthlp_cl_num, dtype=np.int32),
