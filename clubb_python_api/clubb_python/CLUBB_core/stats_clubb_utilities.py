...
def stats_accumulate(
    ...
    dt: float, l_implemented: bool, l_host_applies_sfc_fluxes: bool,
    ...
    clubb_f2py.f2py_stats_accumulate(
        float(dt), bool(l_implemented), bool(l_host_applies_sfc_fluxes), bool(l_stability_correct_tau_zm),
        ...
        f_arr(thvm), f_arr(ug), f_arr(vg), f_arr(ddzt_umvm_sqd), f_arr(stability_correction),
        f_arr(kh_zt), f_arr(rsat), f_arr(kh_zm), f_arr(em), f_arr(wp3_on_wp2),
        f_arr(wp3_on_wp2_zt),
