...
def test_stats_accumulate_smoke():
    ...
    try:
        clubb_api.stats_accumulate(
            ...
            dt=60.0,
            l_implemented=True, l_host_applies_sfc_fluxes=False,
            ...
            thvm=zt(300.0), ug=zt(1.0), vg=zt(0.0),
            ddzt_umvm_sqd=zm(0.0), stability_correction=zm(1.0),
            kh_zt=zt(1.0), rsat=zt(0.01), kh_zm=zm(1.0), em=zm(0.0),
