...
RUN_SCM_SCRIPT = RUN_SCRIPTS / "run_scm.py"
MULTICOL_SCRIPT = UTILITIES / "create_multi_col_params.py"
...
try:
    ...
    rc, run_output = run_command(run_cmd, cwd=RUN_SCRIPTS, env=run_env)
    if rc != 0:
