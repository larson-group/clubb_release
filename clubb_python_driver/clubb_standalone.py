...
Usage:
    python -m clubb_python_driver.clubb_standalone input/case_setups/bomex_model.in
    python -m clubb_python_driver.clubb_standalone input/case_setups/bomex_model.in --quiet
"""
import sys
import time
...
def main():
    if len(sys.argv) < 2 or sys.argv[1] in ('-h', '--help'):
        print("Usage: python -m clubb_python_driver.clubb_standalone <namelist_path> [--quiet]")
