...
\end{equation}
where $\zeta_i$ is the amount of the PDF occupied by category $i$ and $S_i$ is
the ``sample probability'' of the category.
...
Thus, rather than choose sample points that match the $P(\mathbf{x})$
