...
the rate of change due to the positive-definite hole-filling scheme,
the subscript $\left.\right|_{\rm{cl}}$ stands for the rate of
change due to completely explicit clipping,  the subscript 
...
$\left.\right|_{\rm{cl}}$ term), and substitute
