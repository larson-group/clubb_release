...
=& - \bar{w}\ptlder{\overline{q^{'2}_t}}{z}	  
   ...
   - \dfrac{C_2}{\tau} \left(   \overline{q_t^{'2}} 
                              - \left. q_t \right|_{\rm{tol}}^{2} \right) \\
 & + \ptlder{}{z} \left[ \left( K_{w2} + \nu_2 \right)
                         \ptlder{}{z} \overline{q_t^{'2}} 
                  \right]
   + \left. \ptlder{\overline{q_t^{'2}}}{t} \right|_{\rm{pd}}
   + \left. \ptlder{\overline{q_t^{'2}}}{t} \right|_{\rm{cl}}
\end{split}
\end{equation}
%
\begin{equation}
...
=& - \bar{w}\ptlder{\overline{\theta^{'2}_l}}{z}	 
   ...
   - \dfrac{C_2}{\tau} \left(   \overline{\theta_l^{'2}} 
                              - \left. \theta_l \right|_{\rm{tol}}^{2} \right) \\
 & + \ptlder{}{z} \left[ \left( K_{w2} + \nu_2 \right)
...
= & - \bar{w}\ptlder{\overline{w'q'_t}}{z}	 		
  ...
  & - C_7 \left(
    ...
    + \ptlder{}{z} \left[ \left( K_{w6} + \nu_6 \right)
                          \ptlder{}{z} \overline{w'q'_t} 
                   \right]
    + \left. \ptlder{\overline{w'q'_t}}{t} \right|_{\rm{sicl}}
    + \left. \ptlder{\overline{w'q'_t}}{t} \right|_{\rm{cl}}
\end{split}
\end{equation}
%
\begin{equation}
...
for $\overline{w^{'2}}$; 
$\left. q_t \right|_{\rm{tol}}^{2}$ is the minimum threshold value
for $\overline{q_t^{'2}}$; and 
...
Where, $\epsilon$, the dissipation of $\bar{e}$, is defined in CLUBB as:
\begin{equation}
...
Start with (\ref{eq_qtp2}) (for simplicity, neglect the 
$\left.\right|_{\rm{pd}}$ and $\left.\right|_{\rm{cl}}$ terms), substitute 
(\ref{eq_wpqtp2}), assume steady-state and rearrange:
%
\begin{equation}
\begin{split}
\label{eq_qtp2_ss}
...
=& - \left( 1 - \frac{1}{3}\beta \right)
       \ptlder{}{z}
         ...
         \right)
   - 2 \, \overline{w'q'_t} \, \ptlder{\bar{q}_t}{z} 
   + \dfrac{C_2}{\tau} \left. q_t \right|_{\rm{tol}}^{2}
\end{split}
\end{equation}
%
...
\begin{equation}
\mathtt{ rhs(k) = rhs(k) + \frac{C_2}{taum(k)} qttol^{2} }
\end{equation}


\subsection{ $\overline{q_t'\theta_l'}$  }

Start with (\ref{eq_qtpthlp}) (for simplicity, neglect the 
$\left.\right|_{\rm{cl}}$ term), substitute (\ref{eq_wpqtpthlp}), assume 
...
implicitly.
Start with eqs (\ref{eq_qtm}), (\ref{eq_wpqtp}) (for simplicity, neglect the 
$\left.\right|_{\rm{sicl}}$ and $\left.\right|_{\rm{cl}}$ terms), and substitute
expression for the transport term (\ref{eq_wp2qtp}):
%
\begin{equation}
\ptlder{\bar{q}_t}{t}
= - \bar{w}\ptlder{\bar{q}_t}{z} 
