...
= & \underbrace{ - \bar{w}\ptlder{\overline{w^{'3}}}{z} }_{ma}
  ...
  & \underbrace{ - C_{15} K_m \left( 
			...
			-\left(
                             \ptlder{\overline{u'w'}}{z} \ptlsqd{\bar{u}}{z}
                           - \ptlder{\overline{v'w'}}{z} \ptlsqd{\bar{v}}{z}
			\right) \right)
               }_{bp2} \\
...
and temperature forcings, respectively, and $g$ is the gravity.   The set of
...
semi-implicit clipping scheme; and the subscript $\left.\right|_{\rm{cl}}$
stands for the rate of change due to completely explicit clipping.
