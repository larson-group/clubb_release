...
\item When using allocatable pointers they should be deallocated in the same function or subroutine 
...
derived types that contain allocatable components. E.g. \\
\begin{verbatim}
  function func
