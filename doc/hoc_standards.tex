...
\item All non-fatal print or write statements should recast as clubb_debug( 1 or 2, “message”) or
should be enclosed in clubb_at_least_debug_level( 1 or 2 ) conditionals. All fatal errors should
be write statements to stderr (\verb|clubb_constants fstderr|) with no clubb_at_least_debug_level conditional.
