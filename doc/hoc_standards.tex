...
are not used already.  Currently the module prognostic\_variables is used in 
\texttt{numer\_check.F}, and \texttt{clubb\_driver}, and diagnostic\_variables 
is used in \texttt{clubb\_driver}, texttt{clubb\_core}, 
