...
\begin{verbatim}
  ! known magic number
\end{verbatim}
This will cause the check_for_errors.py script from saying that there is a 
...
\begin{verbatim}
  ! known magic flag
\end{verbatim}
This will prevent the check_for_errors.py script from saying that there is a
