%
% $Id: hoc_standards.tex,v 1.2 2008-08-06 16:48:45 dschanen Exp $
%
...
module dynamics
  ...
  subroutine advect_2D( ... )
    use grid, only: & ! 2+2 columns within the scope of dynamics/advect_2D
      nz, & ! 2+2+2 columns since we're continuing the 'use' statement
      nx
...
allows for 134, but the number 100 was chosen to keep the line length 
within reason.  \newline
