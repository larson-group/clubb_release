# $Id: linux_x86_64_gfortran.bash 5832 2012-05-24 21:16:44Z dschanen@uwm.edu $
...
NETCDF="/usr/local/netcdf-gcc-g++-gfortran" #NCAR
OPENMPI="/usr/local/openmpi-gcc-gfortran" #NCAR

# == LAPACK libraries ==
LAPACK="-llapack -lblas" # The netlib reference LAPACK/BLAS #NCAR
...
LDFLAGS="$ARCH -L$NETCDF/lib -lnetcdf -lnetcdff $LAPACK" # Ubuntu #NCAR
