...
LDFLAGS="-L$NETCDF/lib -lnetcdff $LAPACK -L$GPTL/lib -lgptlf -lgptl -L/opt/cray/pe/perftools/23.09.0/lib64/libunwind -lunwind"
...
CPPDEFS="-DNETCDF -DCLUBB_REAL_TYPE=8 -DGPTL -DMPI"
CPPFLAGS="-I$NETCDF/include -I$GPTL/include"
