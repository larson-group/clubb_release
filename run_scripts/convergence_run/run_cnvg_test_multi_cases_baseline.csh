...
#
# csh run_cnvg_test_multi_cases_baseline.csh
#
# to run all five test cases.
#
# Call this script using:
#
# csh run_cnvg_test_multi_cases_baseline.csh dycoms
#
...
set config_flags = "-rad-off -micro-off -standard-aterms -splat-off -new-ic -new-bc"
